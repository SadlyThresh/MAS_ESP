...
label monika_short_stories_menu:
    ...
    python:
        ...
        if len(stories_menu_items) < len(stories) and mas_can_unlock_story:
            ...
            stories_menu_items.insert(0, ("Una nueva historia", return_label, True, False))
        ...
        switch_item = (
            "Me gustaría escuchar una " + switch_str + " historia",
...
label mas_story_begin:
    python:
        story_begin_quips = [
            _("Muy bien, comencemos la historia."),
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_tyrant",
        prompt="El Gato y el Gallo",unlocked=True),code="STY")
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_despise",
        prompt="El Zorro",unlocked=False),code="STY")

label mas_story_despise:
    call mas_story_begin
    m 1eud "Un caluroso día de verano, un zorro paseaba por un huerto hasta que llegó a un racimo de uvas que estaba madurando en una vid que había sido amasada sobre una rama alta."
    m 1tfu "'Lo justo para saciar mi sed', dijo el Zorro."
    m 1eua "Retrocediendo unos pasos, corrió y saltó, y se perdió del grupo."
    m 3eub "Dando la vuelta de nuevo con un uno,{w=1.0} dos,{w=1.0} tres,{w=1.0} saltó, pero sin mayor éxito."
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_lies",
        prompt="El Pastorcito y el Lobo",unlocked=False),code="STY")
...
label mas_story_lies:
    ...
    m 4hfw "Corrió hacia el pueblo gritando '¡Lobo! ¡Lobo!' y los aldeanos salieron a recibirlo."
    ...
    m 1ekc "El niño gritó '¡Lobo, Lobo!' aún más fuerte que antes."
    ...
    m 2dsc "Así que el Lobo hizo una buena comida del rebaño del niño."
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_grasshoper",
        prompt="El Saltamontes",unlocked=False),code="STY")
...
label mas_story_grasshoper:
    ...
    m 3eud "'¿Por qué no vienes a charlar conmigo?', dijo el Saltamontes, '¿en lugar de trabajar de esa manera?'"
    m 1efc "'Estoy ayudando a guardar comida para el invierno', dijo la hormiga, 'y te recomiendo que hagas lo mismo'."
    m 1hfb "'¿Por qué preocuparse por el invierno?', dijo el Saltamontes; '¡ahora tenemos mucha comida!'"
    m 3eua "La hormiga siguió su camino."
    m 1dsc "Cuando llegó el invierno, el Saltamontes no tenía comida y se encontró muriendo de hambre, mientras veía a las hormigas distribuir maíz y granos de las tiendas que habían recolectado en el verano."
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_wind_sun",
        prompt="El viento y el Sol",unlocked=False),code="STY")
...
label mas_story_wind_sun:
    ...
    m 3efd "'Cualquiera de nosotros que pueda hacer que ese viajero se quite la capa será considerado el más fuerte. Tu empiezas'."
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_seeds",
        prompt="Las Semillas",unlocked=False),code="STY")
...
label mas_story_seeds:
    ...
    m 1tfd "'Cuidado con ese hombre', citó la Golondrina."
    m 3eud "'¿Por qué, qué está haciendo?' preguntaron los demás."
    ...
    m 3hfu "'¿Qué les dije?' dijo la golondrina."
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_gray_hair",
        prompt="El Cabello Gris",unlocked=False),code="STY")
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_fisherman",
        prompt="El Pescador",unlocked=False),code="STY")
...
label mas_story_fisherman:
    ...
    m 3ekd "'¡Por favor tenga piedad, señor pescador! Soy tan pequeño que no vale la pena llevarme a casa. ¡Cuando sea más grande, le prepararé una comida mucho mejor!'"
    m 1eud "Pero el Pescador rápidamente puso el pescado en su canasta."
    m 3tfu "'Qué tonto tendría que ser', dijo, 'para devolverte. Por pequeño que seas, eres mejor que nada'."
...
init 5 python:
    ...
    prompt="Los Tres Deseos del Viejo",unlocked=False),code="STY")
...
label mas_story_ravel:
    ...
    m 3eud "'¿Tercer deseo?' El hombre estaba desconcertado. '¿Cómo puede ser un tercer deseo si no he tenido un primer y segundo deseo?'"
    m 1tfd "'Ya tenías dos deseos', dijo la bruja, 'pero tu segundo deseo era que yo lo devolviera todo a la forma en que estaba antes de que hicieras tu primer deseo'."
    m 3tku "'Por eso no recuerdas nada: porque todo está como estaba antes de pedir cualquier deseo'."
    m 1dsd "'Está bien', —dijo el hombre—, 'no creo en esto, pero no hay nada de malo en desear. Deseo saber quién soy'."
    m 1tfb "'Es curioso' —dijo la anciana mientras le concedía su deseo y desaparecía para siempre. 'Ese fue tu primer deseo'."
    return
...
label mas_story_genie_regret:
    ...
    m "A lo largo de sus años, había visto el mundo cambiar con el tiempo y concedido deseos a cualquiera que se cruzara en su camino."
    m 1esc "Con cuánto tiempo había vivido, había visto muchas cosas,{w=0.2} {nw}"
    extend 1rsc "algunas de ellas desagradables."
    m 1ekd "Guerras, desastres naturales, la muerte de todos los amigos que hizo..."
    m 1rkc "Sabía que algunas de las cuales eran causadas por deseos que había concedido."
    m 1ekc "Al principio, no estaba demasiado preocupado por las consecuencias...pero después de un tiempo, comenzó a molestarlo cada vez más."
    m 1ekd "Había llegado a un mundo simple, hermoso y puro, y le había causado un daño inconmensurable."
    ...
    m 2dkd "Esto fue algo con lo que tuvo que vivir por el resto de su vida."
    m 2ekc "Quería que las cosas volvieran a ser como eran, pero sus súplicas siempre caían en oídos sordos."
    m 2eka "Sin embargo, a medida que pasaba el tiempo, conoció a algunas personas e hizo amigos que le enseñaron a seguir adelante a pesar de todos sus actos."
    m "Si bien era cierto que fue él quien concedió los deseos que iniciaron el caos...{w=0.5}{nw}"
    extend 2ekd "algunos estaban destinados a suceder incluso sin él."
    m 3ekd "Siempre habría celos e injusticia entre la gente...{w=0.3}{nw}"
    extend 3eka "pero aun así, el mundo seguía funcionando bien."
    m 3eua "Iba a vivir con las cosas que había hecho, pero la pregunta seguía siendo qué planeaba hacer al respecto."
    m 1hua "Fue por todo lo que había pasado, que pudo aprender y seguir adelante,{w=0.3} mejor que antes."
    m 1eua "Espero que te haya gustado la historia, [player]."
    m 1eka "La moraleja de la historia es que, incluso si has hecho cosas de las que te arrepientes, no debes dejar que eso te deprima."
    m 3ekd "Ocurrirán errores, la gente saldrá herida.{w=0.5} Nada cambiará eso."
    m 3eka "La verdad es que muchas veces tendemos a culparnos por cosas que probablemente hubieran sucedido con o sin nuestra participación."
    m 3eub "De hecho, es a través del arrepentimiento que aprendemos la compasión, la empatía y el perdón."
    m 3eua "No puedes cambiar el pasado, pero necesitas perdonarte a ti mismo algún día para vivir una vida sin remordimientos."
    m 1eka "En mi caso..."
    m 1rksdlc "Quién sabe qué hubiera pasado en mi mundo si no hubiera hecho nada..."

    $ placeholder = " al menos"
    if persistent.clearall:
        $ placeholder = ""
        m 1eua "Has llegado a conocer a todas y cada una de los miembros del club aquí, así que supongo que no te arrepientes de perderte nada."
        m 1hub "Jajaja~"

    m 1eua "Pero[placeholder] estás aquí conmigo ahora."
    m 3eua "Desde que estamos juntos, definitivamente puedo decir que he crecido y aprendido de mis errores."
    return
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_immortal_love",
        prompt="El Amor Nunca Termina",unlocked=False),code="STY")

label mas_story_immortal_love:
    call mas_story_begin
    m 3eua "Había una pareja casada que vivió felices juntos durante muchos años."
    m "Cada día de San Valentín, el esposo enviaba un hermoso ramo de flores a su esposa."
...
label mas_story_mother_and_trees:
    ...
    extend 2eud "era que ella hablaba a menudo con sus árboles."
    ...
    m 1eka "Pero todavía no entendía realmente...{w=0.2}{nw}"
...
label mas_story_self_hate:
    ...
    m "No había nada que ganar con asesinarla en absoluto."
    ...
    if persistent._mas_pm_love_yourself is False:
        m 3ekc "Oye [player], ¿recuerdas cuando te pregunté si te amabas a ti mismo?"
...
init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_o_tei",
        prompt="La historia de O-Tei",unlocked=False),code="STY")
...
label mas_story_o_tei:
    ...
    m "'Y ahora he vuelto, Kenji, mi futuro marido'."
    ...
    m 1hua "No mucho después, Kenji se casó con ella tan pronto como pudo, y vivió feliz por el resto de sus vidas."
    return

init 5 python:
    addEvent(Event(persistent._mas_story_database,eventlabel="mas_story_crow_and_pitcher",
        prompt="El Cuervo y la Jarra",unlocked=False),code="STY")
...
label mas_scary_story_setup:
    ...
    python:
        story_begin_quips = [
            _("Muy bien, empecemos la historia."),
            _("¿Listo para oír la historia?"),
            _("¿Listo para la hora del cuento?"),
            _("Empecemos."),
            _("¿Estás listo?")
        ]
...
label mas_scary_story_hunter:
    ...
    m 3esa "Un día, un cazador salió a cazar en el bosque."
    ...
    m 3esc "El vendedor se le apareció al cazador mientras lamentaba su trágica pérdida, y le reveló que en realidad era el diablo."
    ...
    m 1dsd "...{w=1}o así lo haría."
    m 1dsc "Mucho después de su muerte, se enamoró de otra mujer y pronto se casó con ella, olvidando su amor pasado."
    m 1esc "Fue hasta que un año después del fatal incidente, mientras el cazador cabalgaba por el bosque persiguiendo alguna caza, se encontró con el lugar donde mató a su amada..."
    ...
    m "Se acercó al cazador, despreciándolo por su infidelidad y prometiendo venganza por haberla asesinado."
    m "El cazador se alejó preso del pánico."
    m 1euc "Después de un corto camino, miró detrás de él para ver si ella lo seguía más..."
    m 1wkd "...y para su horror,{w=1} vio que ella le había ganado significativamente."
    m 3wkd "En su estado de miedo, no pudo evitar la rama que estaba delante de él, y rápidamente desmontó al cazador de su corcel y lo bajó al frío suelo."
    m 4dsc "Sin embargo, su atención no estaba en su caballo, ya que la criatura se alejó sin él."
...
label mas_scary_story_kuchisake_onna:
    ...
    m 1cua "{b}{i}¿S o y b o n i t a?{/i}{/b}"
    # 1 in 15
...
label .end:
    ...
    m "Conocerla no siempre sellará tu perdición."
    m 3esc "Sin embargo..."
    m "Si no eres inteligente con la forma en que manejas la pregunta..."
    m 3tku "Puede que acabes como ella."
    call mas_scary_story_cleanup
    return
...
label mas_scary_story_ubume:
    call mas_scary_story_setup
    m 3euc "Una noche, a última hora, una mujer entró en una confitería para comprar dulces justo antes de que el dueño estuviera a punto de irse a la cama."
    m 1esc "El pueblo era pequeño y el pastelero no reconoció a la mujer, pero no le dio mucha importancia."
    ...
    m 3wud "Después de salir por la puerta, el confitero miró en su caja de dinero y vio las monedas que la mujer le había dado convertidas en hojas de un árbol."
    # 1 in 20
    ...
    m 1dsd "Sacaron al niño de la tumba y el monje lo tomaría como propio para criarlo."
...
label mas_scary_story_womaninblack:
    ...
    m "Su atuendo era completamente negro, incluido un velo que oscurecía su rostro."
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt="María de la Resurrección",unlocked=False),
    code="STY")
...
label mas_scary_story_baobhan_sith:
    ...
    m 3esb "Cuando los hombres se acomodaron, encendieron un fuego y comenzaron a comer y beber alegremente, porque había sido un buen día."
    ...
    m 1wuo "Luego, para su horror, se dió cuenta de que a los otros hombres les salía sangre del cuello a las camisas."
...
label mas_scary_story_serial_killer:
    call mas_scary_story_setup
    m 3tub "Una joven pareja estacionó su auto junto a un gran sauce en un cementerio una noche para 'hacer el amor' sin ser molestados."
...
label mas_scary_story_yuki_onna:
    ...
    m 2eua "Pudieron hacer una hoguera modesta y se acurrucaron juntos para calentarse antes de quedarse dormidos."
    ...
    m 4wud "Cuando se volvió hacia el hijo, hizo una pausa. La mujer le dijo que le evitaría la misma suerte, porque era joven y muy guapo."
...
label mas_scary_story_many_loves:
    call mas_scary_story_setup
    m 4esa "Había una vez una mujer joven que apareció en un pueblo un día para encontrar marido."
...
label mas_scary_story_flowered_lantern:
    ...
    m 1hua "...¡Y eso es todo por la primera parte! ¿Quieres continuar con la siguiente?{nw}"
    $ _history_list.pop()
    menu:
        m "...¡Y eso es todo por la primera parte! ¿Quieres continuar con la siguiente? {fast}"
        "Sí.":
...
init 5 python:
    addEvent(
        Event(
            ...
            category=[store.mas_stories.TYPE_SCARY],
            prompt="La Linterna Florecida 2",
            pool=True,
            unlocked=False
        ),
        code="STY"
...
label mas_scary_story_flowered_lantern_2:
    ...
    m 2euc "Esta vez, sin embargo, el sirviente de Hagiwara se despertó y escuchó la voz de una mujer joven que no reconoció."
    ...
    m 1efc "A la mañana siguiente, el criado se acercó a su amo y le preguntó por la mujer."
    ...
    m 4ekc "El sirviente le contó a Hagiwara lo que vio la noche anterior y sintió que seguramente la vida de su amo estaba en peligro y le suplicó que viera a un sacerdote al respecto."
    ...
    m 4wuc "Intrigado, caminó hacia él, mientras miraba el nombre de la persona a la que pertenecía, saltó hacia atrás con miedo al leer que pertenecía a su amada Tsuyu."
    m 2wkc "Aterrorizado, Hagiwara se dirigió inmediatamente al templo vecino y pidió hablar con el sacerdote principal."
    m 4esc "Cuando fue admitido, le contó al sumo sacerdote todo lo que había sucedido."
    m 4esd "Una vez que terminó, el sumo sacerdote le dijo que su vida estaba en peligro."
    ...
    m 4dsc "El amor entre uno que está vivo y uno que está muerto sólo puede resultar en la muerte del que está vivo."
    if _mas_lantern_scare or persistent._mas_pm_likes_spoops or mas_full_scares:
        hide mas_lantern
...
init 5 python:
    addEvent(
        Event(
            ...
            category=[store.mas_stories.TYPE_SCARY],
            prompt="La Linterna Florecida 3",
            pool=True,
            unlocked=False
        ),
        code="STY"
...
label mas_scary_story_flowered_lantern_3:
    ...
    m 1eud "Como era el último día del Festival de los Muertos, Tsuyu tendría que regresar con los muertos esta noche y se llevaría a Hagiwara con ella si se volvieran a ver."
    m 3esd "Hagiwara le suplicó al sacerdote que lo ayudara."
    m 3esc "El sacerdote dijo que el karma pasional entre ellos era muy fuerte, pero que todavía había algo de esperanza."
    m "Le entregó a Hagiwara una pila de talismanes de papel que mantienen alejados a los espíritus y le indicó que cubriera todas las aberturas de su casa, sin importar cuán pequeñas fueran, con ellas."
    ...
    if _mas_rects_scare:
        ...
        $ pause(1.5)
        hide black
    m 2dsc "Al día siguiente, el criado se despertó, se acercó a la habitación de su amo y llamó a su puerta."
