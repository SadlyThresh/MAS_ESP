...
init -100 python in mas_selspr:
    ...
    PROMPT_MAP = {
        ...
        "earrings": {
            ...
            "_min-items": 1,
            "change": "¿Puedes cambiarte los pendientes?",
            "wear": "¿Puedes ponerte pendientes?",
        },
        "hair": {
...
label mas_selector_generic_sidebar_select_acs(acs_type, use_acs=None, set_compat_flags=True, launch_exp="monika 1eua", idle_exp=None, sel_group=None, idle_dlg=None):
    python:
        ...
        if sel_group is None:
            sel_group = acs_type
        if idle_dlg is None:
            idle_dlg = "¿Cuál {0} te gustaría que usara?".format(acs_type)
...
label monika_hairclip_select:
    call mas_selector_generic_sidebar_select_acs("left-hair-clip", idle_dlg="¿Qué pinza de pelo quieres que lleve?")
    return
