...
translate Spanish monika_gtod_tip000_0283b9ac:
...
translate Spanish monika_gtod_tip001_bf730d17:
    ...
    m 1esd "Cláusulas independientes pueden ser consideradas por sí solas como frases, como en la frase '{b}Yo escribí eso{/b}'."
...
translate Spanish monika_gtod_tip002_e5cdb645:
    ...
    m 1eua "¿Recuerdas cuando hablamos de cláusulas, [player]?"
...
translate Spanish monika_gtod_tip003_bb5572e8:
    ...
    m 1eub "¡Está bien, [player]! Creo que es hora de que hablemos de...{w=0.5}conjunciones!"
...
translate Spanish monika_gtod_tip003_3d85a4fa:
    ...
    m 3eua "Como verás, las conjunciones son excelentes para combinar ideas, y al mismo tiempo, hacen que tu escritura suene fluida y más parecida a la forma en que realmente hablamos."
...
translate Spanish monika_gtod_tip003_509682de:
    ...
    m 1rksdla "Pero evita exagerar con ellos. O si no, sonarás un poco forzado."
...
translate Spanish monika_gtod_tip004_53d4afb0:
    ...
    m 1eub "Las tres oraciones transmiten el mismo mensaje, pero en comparación, '{b}Estás aquí; Estoy feliz{/b}' conecta las dos cláusulas en un medio feliz."
...
translate Spanish monika_gtod_tip005_1c3ad591:
    ...
    m 1eua "Entonces, en la oración '{b}Observamos los fuegos artificiales juntos{/b}', el objeto sería...{w=0.5} los '{b}fuegos artificiales{/b}'."
...
translate Spanish monika_gtod_tip005_6f3fed75:
    ...
    m 3hub "¡Gracias por escuchar, [player]! Me encanta."
...
translate Spanish monika_gtod_tip007_f12d9e50:
    ...
    m 1euc "'{b}Que{/b}' corresponde a '{b}él{/b}/{b}ella{/b}/{b}ellos{/b}' mientras que '{b}quién{/b}' corresponde '{b}él{/b}/{b}ella{/b}/{b}ellos{/b}'."
...
translate Spanish monika_gtod_tip009_a564d647:
    ...
    m 1eua "Olvíde mencionar que el apóstrofe es bastante común de presenciar en el discurso político, le da más impacto y resonancia a las palabras empleadas."
...
translate Spanish monika_gtod_tip009_50e7b768:
    ...
    m 1eub "Bien, [player], ya es hora de terminar...{w=0.5}Creo que esta lección se ha extendido un poco."
...
translate Spanish monika_gtod_tip010_cf2e6935:
    ...
    m 3eud "[player], ¿Sabes cuál es la diferencia entre 'al final' y 'a la final'?"
...
translate Spanish monika_gtod_tip010_890ed304:
    ...
    m 3eub "Puede que pienses que es lo mismo, y normalmente la gente suele emplearlos como un recurso para finalizar una oración."

# game/script-grammar.rpy:397
translate Spanish monika_gtod_tip010_2004644b:

    # m 1esa "Let me show you what I mean..."
    m 1esa "Pero si tu intención es finalizar una oración con un remate, lo ideal sería que usaras 'al final', ya que, 'a la final' hace referencia a un lugar o evento."
...
translate Spanish monika_gtod_tip010_04f8d78a:
    ...
    m 1hub "Por ejemplo, con 'al final' puedes decir '{b}Al final no obtuve los resultados que quería{/b}'."
...
translate Spanish monika_gtod_tip010_6c231df4:
    ...
    m 1eua "En cambio, si quieres referirte a un evento final, como un partido o algo que concluirá, puedes decir...{w=0.5}'{b}Natsuki irá a la final de su concurso de repostería{/b}'."
...
translate Spanish monika_gtod_tip010_6be40e6a:
    ...
    m 3eud "La confusión ocurre porque mucha gente no conoce la diferencia entre estos dos términos y suelen usar 'a la final' para dar remate a las oraciones."
...
translate Spanish monika_gtod_tip010_af5fe8a0:
    ...
    m 3hub "Por supuesto, ahora que sabes esto...{w=0.5}'{b}A la final no obtuve los resultados que quería{/b}' no suena nada bien, ¡jajaja!"
