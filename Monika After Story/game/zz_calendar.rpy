...
init python:
    ...
    calendar.addRepeatable("New years day",_("Día de Año Nuevo"),month=1,day=1,year_param=list())
    calendar.addRepeatable("Valentine",_("Día de San Valentín"),month=2,day=14,year_param=list())

    calendar.addRepeatable("April Fools",_("Día que me convertí en IA"),month=4,day=1,year_param=[2018])
    calendar.addRepeatable("Monika's Birthday",_("Mi cumpleaños"),month=9,day=22,year_param=range(1999,MASCalendar.MAX_VIEWABLE_YEAR))
    calendar.addRepeatable("Halloween",_("Halloween"),month=10,day=31,year_param=list())
    calendar.addRepeatable("Christmas eve",_("Nochebuena"),month=12,day=24,year_param=list())
    calendar.addRepeatable("Christmas",_("Navidad"),month=12,day=25,year_param=list())
    calendar.addRepeatable("New year's eve",_("Vispera de Año Nuevo"),month=12,day=31,year_param=list())
...
label _first_time_calendar_use:
    ...
    m 1lksdla "Excepto cuando estoy en medio de una conversación, por supuesto."
