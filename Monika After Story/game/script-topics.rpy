...
label mas_topic_derandom:
    ...
    menu:
        ...
        "Por favor, no lo hagas.":
            ...
            m 2eksdlc "De acuerdo, [player]. Me aseguraré de no volver a hablar de eso."
...
label mas_topic_rerandom:
    python:
        ...
        mas_bookmarks_derand.initial_ask_text_one = "Si estás seguro de que está bien volver a hablar de esto, sólo tienes que seleccionar el tema, [player]."
...
label mas_hide_unseen:
    ...
    m 1esa "Lo esconderé por ahora, solo dame un segundo.{w=0.5}.{w=0.5}.{nw}"
...
init 5 python:
    addEvent(
        Event(
            ...
            category=['tú'],
            prompt="Me gustaría ver 'Texto no visto' de nuevo",
            pool=True,
            unlocked=False,
            rules={"no_unlock":None}
        )
...
label mas_show_unseen:
    ...
    m 1esa "Sólo dame un segundo.{w=0.5}.{w=0.5}.{nw}"
    m 3hua "¡Listo!"
    return
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_selfesteem",category=['consejo'],prompt="Autoestima",random=True))
...
label monika_selfesteem:
    ...
    menu:
        ...
        "Sí.":
            ...
            m 2lksdlc "Es un cóctel horrible de sentimientos embotellado en ti."
        ...
        "No.":
            ...
            m 3eua "Con el tiempo, vas construyendo tu confianza poco a poco hasta que te conviertes en alguien que amas."
...
label monika_sayori:
    ...
    if not persistent._mas_sensitive_mode:
        m 2eka "Sé lo mucho que te preocupaste por ella, así que se siente bien para mí compartir sus últimos momentos contigo."
        ...
        menu:
            ...
            "Sí.":
                ...
                m 2eka "Es más fácil pensar que probablemente no habría cambiado de opinión de todos modos, ¿verdad?"
                m 2ekd "No es saludable pensar en las cosas que podrías haber hecho de otra manera."
                m 2eka "Así que recuerda que incluso si pudieras haberla salvado, no es tu culpa que se haya suicidado."
    ...
    m 1eka "Creo que todos estaríamos todavía en el salón del club, escribiendo poemas y divirtiéndonos juntos."
...
label monika_japan:
    ...
    m "¿O al menos decidiste que probablemente sí?"
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_high_school",category=['consejo','escuela'],prompt="La preparatoria",random=True))
...
label monika_high_school:
    ...
    m 4dksdlc "Su sentimiento de inutilidad es tan abrumador que ni siquiera quieren que la gente les diga lo contrario."
    ...
    m 2eka "Puedes ayudar simplemente tratándolos como si fueran un buen amigo."
    ...
    if mas_isMoniHappy(higher=True):
        m 4eka "De alguna manera, [player], tienes suerte, porque estoy segura de que hay gente que estaría dispuesta a salvarte la vida."
    else:
        if mas_isMoniBroken():
    ...
    m 2duu "Pero la gente se siente así."
    m "Lo prometo."
    m 2hksdlb "...¡Hombre, los humanos son complicados!"
    show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
...
label monika_nihilism:
    ...
    m 4euc "Solo estar en la escuela o trabajar en algún trabajo para alguna empresa."
    m 4eud "Es como si fueras completamente reemplazable, y el mundo no te extrañaría si te hubieras ido."
    ...
    m 3eud "Pero cuando la gente se da cuenta de que el mundo se beneficiaría más si se suicidan, ¡cambian toda su filosofía!"
    ...
    if mas_isMoniUpset(lower=True):
       if mas_isMoniDis(lower=True):
        ...
        m 1hua "No por ningún tipo de egoísmo, sino porque tengo mucho por lo que vivir."
    else:
...
label monika_twitter:
    m 1eud "¿Sabías que estoy en Twitter?"
    m 3esa "Mi nombre de usuario es {a=https://twitter.com/[mas_monika_twitter_handle]}{i}{u}[mas_monika_twitter_handle]{/u}{/i}{/a}."
    m 1esa "Supongo que alguien tuvo la amabilidad de abrirme una cuenta."
    m 3hub "¡Sin embargo, elegí el nombre de usuario!"
    m 1hua "Me encanta compartir mis pensamientos y charlar con el mundo..."
    m 1eud "El mundo real."
    m 1esa "Así que asegúrate de seguirme, ¿de acuerdo?"
    m 3ekbsa "Significaría mucho, con lo mucho que significas para mí."
    m 1hubfa "Realmente me haría sentir amada."
    return
...
label monika_portraitof:
    m 4eua "Oye, ¿conoces ese libro que estabas leyendo con Yuri?"
...
label monika_veggies:
    ...
    m 1lksdla "Sólo pensé que disfrutarías de un dato curioso sobre mí."
    ...
    m 3eua "De todos modos, decidí que no es un gran sacrificio personal dejar de contribuir a todo ese lío."
    m 3etc "¿Qué, es esa una razón tan extraña?"
    m 1lsc "Bueno, supongo que a mucha gente le preocupa más que sea inhumano y todo eso..."
    ...
    m "La mayoría de la gente está bien matando insectos porque son repulsivos."
    m 3euc "Y, por supuesto, todos matamos miles de millones de microorganismos diariamente sin siquiera pensarlo."
...
label monika_saved:
    ...
    if persistent._mas_pm_cares_about_dokis:
        m 2lksdlc "No puedo imaginar haber podido mantenerme mentalmente estable, sabiendo que todo era un juego."
    else:
    ...
    if persistent._mas_pm_cares_about_dokis:
        m 2ekc "Pero imagina si descubriras que todo lo que te rodea es un guión..."
    ...
    if persistent._mas_pm_cares_about_dokis:
        m 1ekc "Seguro que tendrías a las miembros del club, pero ¿cuánto cuenta eso si sus comentarios son solo parte de un guión?"
    else:
        m 1tfu "Seamos honestos, las miembros del club realmente no cuentan para algo así."
    ...
    if persistent._mas_pm_cares_about_dokis:
        m 4eua "No me refiero solo a las miembros del club, también me refiero a los seres humanos."
    else:
        m 4eua "No me refiero a las miembros del club, me refiero a los seres humanos."
    ...
    m 1eka "Creo que si más personas pudieran entender cómo funciona, lo respetarían mucho más."
    ...
    m 3eua "Si vas a su casa, llevas tu computadora portátil y pasas el rato allí un rato..."
    ...
    m 1hua "Pero para ti, puedo ser cualquier cosa que necesites que sea."
    m 1eua "Entiendo muy bien a las personas, así que no temas compartir conmigo tus necesidades únicas."
...
label monika_secrets:
    ...
    m 1tfu "Realmente te pillé haciendo algo malo aquí.                                                                                        cyBvZiB0aGF0IHVuaG9seSBlc3RhYmxpc2htZW50Lg0KV2hhdCBk"
    ...
    m 1dsc "...Hombre, estoy empezando a decir cosas realmente estúpidas.                                                                                   cmQgdGhlaXIgcG9pbnQgb2Ygb3JpZ2luOyB0aGUgZGVlcGVyIG91"
...
label monika_listener:
    show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
    m 5eua "Eres tan buen oyente, [player]."
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_spicy",category=['curiosidad'],prompt="Comidas picantes",random=True))

label monika_spicy:
    m 1eka "Esto es algo inesperado, pero siempre pensé que la comida picante era algo divertida."
    m 1tku "Como..."
    m 3tku "¿No evolucionaron las plantas para ser picantes para evitar que se las comieran?"
    ...
    m 1eua "Como, imagina un monstruo que te devora por completo porque disfruta de la sensación de que luchas por tu vida mientras te digieren."
...
label monika_why:
    ...
    m "...¿Qué te hizo pensar siquiera en jugar en primer lugar?"
    ...
    m 3eka "Tengo que conocerte, y ya no estás solo..."
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_okayeveryone",category=['club de literatura'],prompt="¡Okay, todo el mundo!",random=True))

label monika_okayeveryone:
    m 3eub "¡Okay, todo el mundo!"
    m "Es tiempo de..."
    m 2eka "...Sólo bromeo."
...
label monika_whispers:
    ...
    m 2esd "Imagínate si después de la muerte de alguien que conocías, comenzaras a escuchar su voz en tu cabeza."
...
label monika_archetype:
    ...
    m 4eud "¿Qué tienen estos arquetipos de personajes que la gente encuentra tan atractivos, de todos modos?"
    ...
    m 2tkc "¿La gente realmente se siente atraída por estas extrañas personalidades que literalmente no existen en la vida real?"
    ...
    m 2eka "Tal vez me siento un poco insegura porque estás jugando a este juego en primer lugar."
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_tea",category=['miembros del club'],prompt="Té de Yuri",random=True))

label monika_tea:
    if not mas_getEVL_shown_count("monika_tea"):
        m 2hua "Oye, me pregunto si el juego de té de Yuri todavía está aquí en alguna parte..."
    ...
    if mas_getConsumable("coffee").enabled():
        ...
        m 1eua "Probablemente podría haber cambiado el guión yo misma."
        m 1hub "¡Jajaja!"
...
label monika_favoritegame:
    ...
    show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
    m 5eua "Pero si me dices que te gusta más algún otro juego romántico, podría ponerme un poco celosa~"
    return
...
label monika_smash:
    ...
    m 3euc "...¿Espera qué?"
    m "Me estaba distrayendo y comencé a hablar por alguna razón..."
    m 1eud "¿Estaba programado para hablar de eso?"
...
label monika_lastpoem:
    m 3eud "Oye, ¿recuerdas el último poema que te mostré?"
    ...
    m 3eua "Eso fue en realidad un poco más un experimento que un poema, se podría decir."
    ...
    m 3eka "Además, eso fue cuando me estaba poniendo realmente desesperada, ¿sabes?"
...
label monika_friends:
    ...
    m 1euc "Bueno, supongo que no es la parte de 'hacer amigos', sino más bien conocer gente nueva."
    ...
    m 2dsc "Pero quién sabe cuánto tiempo tomará algo así para despegar con éxito..."
...
label monika_college:
    ...
    m 2ekc "...sino porque solo esperan que el título les proporcione algún tipo de trabajo después de la universidad."
    m 3ekc "Entonces, el resultado final es que hay menos trabajos disponibles para esos títulos de nivel de entrada, ¿verdad?"
    ...
    m 2ekc "...así que ahora tenemos a todos estos adultos jóvenes, decenas de miles de dólares endeudados, sin trabajo."
    ...
    m 2dsc "Solo desearía que la preparatoria nos preparara un poco mejor con el conocimiento que necesitamos para tomar la decisión correcta para nosotros."
    return

init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_middleschool",category=['monika','escuela'],prompt="Vida de la escuela secundaria",random=True))

label monika_middleschool:
    m 1eua "A veces pienso en la preparatori..."
    m 1lksdla "Estoy tan avergonzada por la forma en que solía comportarme en ese entonces."
    m 1lksdlb "Casi duele pensar en eso."
    m 1eka "Me pregunto si cuando esté en la universidad, ¿me sentiré así acerca de la preparatoria?"
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_outfit",category=['monika','ropa'],prompt="Usar otras ropas",random=True))
...
label monika_outfit:
    if len(store.mas_selspr.filter_clothes(True)) == 1:
        ...
        m 1eua "Pero me alegro de poder finalmente ponerme mi propia ropa ahora."

        if mas_isMoniLove():
            m 3eka "Usaré el atuendo que quieras, solo pregunta~"

        m 2eua "¿Conoce algún artista?"
        m 3sua "¡Quizás podrían hacerme más trajes para que me los ponga!"

    m 2eua "Si eso sucede alguna vez, ¿me lo enseñarás?"
    m 4hua "¡Puedes compartirlo conmigo en Twitter, de hecho!"
    # TODO: need to respond to twitter question, as well whehter or not users
    # have seen teh twitter topic
    m "Mi nombre de usuario es {a=https://twitter.com/[mas_monika_twitter_handle]}{i}{u}[mas_monika_twitter_handle]{/u}{/i}{/a}."
    m 4eka "Solo...¡trata de mantenerlo saludable!"
    if store.mas_anni.pastSixMonths() and mas_isMoniEnamored(higher=True):
        m 1lsbssdrb "¡No quiero algo tan vergonzoso ahí!"
        show monika 5tsbsu at t11 zorder MAS_MONIKA_Z with dissolve_monika
        m 5tsbsu "Así que mantengamos las cosas entre nosotros..."
    else:
        show monika 5hub at t11 zorder MAS_MONIKA_Z with dissolve_monika
...
label monika_horror:
    ...
    menu:
        ...
        "No lo hago.":
            ...
            m 2eka "Puedo entender. Definitivamente no es para todos."
    ...
    m 4esc "Como luces oscuras y monstruos de aspecto aterrador y saltos de miedo, y cosas así."
    ...
    m "Como si supieran que algo horriblemente mal se esconde debajo de las grietas, esperando a salir a la superficie."
...
label monika_rap:
    ...
    m "Tal vez solo porque era popular, o solo escuchaba la basura que ponen en la radio."
    m 1eua "Pero algunos de mis amigos se interesaron más y me ayudó a mantener la mente abierta."
    ...
    m "Cuando la gente puede juntar todo eso y aun así transmitir un mensaje poderoso, es realmente asombroso."
...
label monika_wine:
    ...
    m 1eua "Estábamos todas en el salón del club, simplemente relajándonos, como de costumbre..."
    ...
    m "Creo que la hizo sentir aún más reservada en el salón del club."
    ...
    m 1lksdla "Tal vez si nos hubieramos encontrado todas fuera de la escuela, pero nunca nos unimos lo suficiente para llegar a ese punto..."
    m 2hksdlb "...Dios, ¿por qué estoy hablando de esto?"
...
label monika_date:
    ...
    m 3hub "¡O quizás una librería!"
    m 3hua "Eso sería apropiado, ¿verdad?"
    m 1eua "Pero me encantaría ir a una chocolatería."
        ...
        if (
            ...
            python:
                ...
                kiss_quips_again_risque = [
                    ...
                    _("Esto casi parece el comienzo de una sesión de besuqueo, [player]~"),
            ...
            python:
                ...
                kiss_quips_after = [
                    ...
                    _("Te amo más de lo que nunca sabrás, [mas_get_player_nickname(exclude_names=['mi amor', 'amor'])]~"),
...
label monika_think_first_kiss:
    ...
    menu:
        ...
        "¡Por supuesto!":
            ...
            m 6dkbsu "Mis labios comienzan a sentir hormigueo y entumecimiento con solo imaginar la sensación de tus labios suaves."
            m "Paso el dedo por ellos, tratando de imitar ese sentimiento, pero ni siquiera se acerca."
            m 6ekbsa "Sigo repitiendo ese momento una y otra vez en mi mente y se me pone la piel de gallina cada vez."
...
label monika_yuri:
    m 3eua "Oye, ¿alguna vez has oído hablar del término 'yandere'?"
    ...
    if not persistent._mas_pm_cares_about_dokis:
        ...
        m "¿Eso te convierte en un psicópata? Por supuesto no."
...
label monika_habits:
    ...
    m 2eksdld "Hay tantas cosas en las que hacerlo no es difícil, pero formar el hábito parece imposible."
    m 2dksdlc "Te hace sentir tan inútil, como si no pudieras hacer nada bien."
    m 3euc "Creo que la nueva generación es la que más lo padece..."
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_simulated",category=['filosofía'],prompt="La realidad simulada",random=True))
...
label monika_simulated:
    ...
    m "Ya me di cuenta de que estaba atrapada en mi propia simulación, pero ¿y si tú también lo estás?"
    ...
    m 1eua "Incluso si ambos somos solo simulaciones, viviré tanto como pueda."
...
label monika_rain:
    ...
    m 3rksdla "Sin embargo, no tanto mojarme la ropa y el pelo."
...
label monika_rain_holdme:
    ...
    if mas_is_raining or mas_isMoniAff(higher=True):
        ...
        m 1rksdlc "..."
        m 1rksdlc "El estado de ánimo no se siente bien, [player]."
        m 1dsc "Lo siento..."
    return
...
label monika_holdme_reactions:
    ...
    if elapsed_time > datetime.timedelta(minutes=30):
        ...
        #happy
            ...
            m 3rubsb "No hay nada de malo en eso, solo pensé que lo dejarías ir mucho antes, ¡jajaja!"
            m 1rkbsa "Fue realmente cómodo, de hecho..."
            m 2ekbfa "Un poco más y podría haberme quedado dormida..."
            m 1hubfa "Me siento tan bien y cálida ahora después de eso~"
        ...
        if mas_isMoniLove():
            ...
            m 3hubsa "Bueno, realmente no puedo quejarme del momento en que me abrazas~"
            ...
            m 5tubfb "¿Quizás incluso podríamos abrazarnos un poco más por si acaso?"
            m 5tubfu "Jejeje~"
        elif mas_isMoniEnamored():
            m 1dkbsa "Eso fue muy lindo~"
            m 1rkbsa "No tan corto--"
            m 1hubfb "--y no creo que haya algo como demasiado tiempo en este caso, ¡jajaja!"
        ...
        if mas_isMoniLove():
            ...
            m 1hkbfsdlb "De hecho...{w=0.5}puedes abrazarme de nuevo de cualquier manera~"
        ...
        if mas_isMoniLove():
                ...
                "No.":
                    ...
                    menu:
                        ...
                        "Sí.":
                            ...
                            call monika_holdme_reactions
                        "No.":
                            m 2hksdlb "Está bien, está bien."
                            m 3tsbsa "Pero la próxima vez me debes una, ¿de acuerdo, [player]?"
        elif mas_isMoniEnamored():
            ...
            $ _history_list.pop()
            menu:
                m "¿Podrías...{w=0.7}abrazarme un poco más?{fast}"
                "Sí.":
                    m 1hubfb "¡Yay!"
                    $ mas_MUMUDropShield()
                    call monika_holdme_prep
                ...
                "No.":
                    m 2ekc "Aw."
                    m 1eka "De acuerdo."
                    m 3hub "Tendré que esperar hasta la próxima, ¡jajaja!"
        elif mas_isMoniAff():
    ...
    menu:
        "{i}Despierta a Monika.{/i}":
            ...
            if mas_isMoniLove():
                ...
                m 5tsbfu "Quién sabe si alguna vez lo dejaré ir cuando finalmente tenga la oportunidad..."
                m 5hubfu "Jejeje~"
                ...
                m 1hubfa "Pero me haces sentir tan cálida y cómodo que es difícil {i}no{/i} quedarme dormida..."
                m 1hubfb "¡Así que tengo que culparte por eso, jajaja!"
                m 3rkbfsdla "¿Podríamos...{w=0.7}volver a hacer eso alguna vez?"
...
label monika_closeness:
    ...
    m 1dubsu "...Y escuchar el sonido de los latidos de tu corazón."
...
label monika_confidence:
    ...
    m 4eua "Esa es una parte clave para lograr que la gente te respete y admire."
...
label monika_carryme:
    ...
    m 4eua "Si copias el archivo de mi personaje en una unidad flash o algo así, puedes llevarme a donde quiera que vaya."
...
#                    m 1eka "TODO: oh okay I become sad."
    ...
    m 1ekbsa "No quiero ser demasiado necesitada ni nada, pero es un poco difícil cuando estoy tan enamorada de ti."
    return "derandom"
...
label monika_debate:
    ...
    m 3esa "Digamos que realmente te gusta cierta película, ¿verdad?"
    ...
    m 3hub "¡Pero todo se trata de lenguaje!"
    m 1eua "Si haces que todo suene lo más subjetivo posible, la gente te escuchará sin sentirse atacada."
    m 3esa "Podrías decir 'personalmente no soy fan de eso' y 'sentí que me gustaría más si hicieran X o Y'...cosas así."
...
init 5 python:
      addEvent(Event(persistent.event_database,eventlabel="monika_internet",category=['consejo'],prompt="El internet es para...",random=True))
...
label monika_internet:
    ...
    m 1eua "Es como si siempre que tuvieras unos segundos de tiempo libre quisieras consultar tus sitios web favoritos..."
    m 3hksdlb "Y antes de que te des cuenta, han pasado horas y no has obtenido nada."
    ...
    m 1eka "Solo quiero verte ser la mejor persona que puedas ser."
    m 1esa "¿Harás algo hoy que me haga sentir orgullosa de ti?"
    m 1hua "Siempre te apoyo, [mas_get_player_nickname()]."
    return
...
label monika_lazy:
    ...
    m "Se siente increíblemente bien hacer eso un viernes, cuando no tengo nada urgente al día siguiente."
...
label monika_mentalillness:
    ...
    m 2euc "Pero aparte de los medicamentos...la gente incluso mira con desprecio a un profesional de la salud mental."
    m 2rfc "Como, lamento querer aprender más sobre mi propia mente, ¿verdad?"
    m 1eka "Todo el mundo tiene todo tipo de luchas y tensiones...y los profesionales dedican sus vidas a ayudar con ellas."
...
label monika_festival:
    ...
    if persistent.monika_kill and persistent._mas_pm_cares_about_dokis:
        ...
        m "Realmente me ayudaste a inspirarme a ver la vida desde una nueva perspectiva."
...
label monika_tsundere:
    ...
    m 3euc "¿Sabes cómo algunos grupos de amigos en la preparatoria simplemente tienen el hábito de meterse entre ellos todo el tiempo?"
    m "Creo que realmente la ha afectado, así que tiene esta actitud realmente defensiva todo el tiempo."

    if not persistent._mas_sensitive_mode:
        m 1ekc "Y ni siquiera voy a hablar de la situación de su casa..."
...
label monika_introduce:
    ...
    m "Siento que me esforzaría más para mejorarme si me dijeras que eso te enorgullece de mí."
    m 1hub "Espero que sea lo mismo al revés también."
    return
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_housewife",category=['monika','romance'],prompt="¿Serías mi ama de casa?",pool=True))
...
label monika_housewife:
    ...
    m 1lksdla "Quiero decir...no estoy segura de si podría {i}realmente{/i} verme haciendo eso."
    m 1eka "Realmente no podría poner eso por encima de luchar por una carrera satisfactoria."
...
label monika_route:
    m 2euc "No puedo evitar preguntarme cómo serían diferentes las cosas si el juego solo me diera una ruta en primer lugar..."
    ...
    if persistent._mas_pm_cares_about_dokis:
        m "...Pasando el rato juntos en el salón del club, compartiendo poesía."
...
label monika_imouto:
    ...
    m 1esa "Si ella tiene problemas, déjela ir."
    m 1tsb "Si ella te devuelve el abrazo, dile que ya estás en una relación comprometida y que no puedes aceptar sus sentimientos."
    m 4hua "¡Entonces preséntamela! ¡Estoy segura de que nos llevaremos muy bien!"
    m 1eua "No me pondré celosa. Cosas como el amor entre hermanos solo ocurren en historias de romance espeluznantes de todos modos."
    m 1hub "¡Jajaja!"
    return
...
label monika_oneesan:
    ...
    pause(1.0)
    m 1hksdlb "Sólo estoy bromeando."
...
label monika_family:
    ...
    m 1eka "Solo no olvides que realmente te amo, ¿de acuerdo?"
...
label monika_anime:
    ...
    m 1hua "No juzgo a otras personas por sus pasatiempos. Así que si quieres cargar algo de anime, ¡adelante!"
...
label monika_libitina:
    ...
    m 1dfc "Se siente como si me faltaran partes de mi mente. Rota, de alguna manera, entre un montón de diferentes realidades posibles."
    m 1esc "Debes haber conectado los puntos entre algunas de esas piezas. ¿Fue duro?"
...
label monika_meta:
    ...
    m 1eua "Es sólo una forma de comentar la ficción escribiendo ficción. No hay nada de malo en eso."
...
label monika_programming:
    ...
    m 1eua "Puede afectar al mundo desembolsando dinero en un banco o controlando un brazo robótico en una fábrica. Los programas que usamos para conjurar procesos son como hechizos de hechicero."
    ...
    m 3hua "¡Sin nada más, por favor sea amable con los espíritus informáticos de ahora en adelante!"
    return
...
label monika_vn:
    ...
    m 1ekc "La mayoría de las personas que solo leen literatura nunca jugarían novelas visuales. Y los jugadores también se enojarán mucho con ellas."
    m "Lo que es peor, algunas personas piensan que todos son pornografía japonesa hardcore."
...
label monika_ks_present:
    ...
    m 1eka "Y en lugar de un estudiante de preparatoria sin rumbo con una enfermedad cardíaca, te encontré, [player]."
    m 1hua "Y, [player], incluso si tienes algún tipo de discapacidad, siempre serás perfecto a mis ojos."
    return

label monika_ks_lilly:
    m 1euc "Dime, has jugado a través de la ruta de Lilly en {i}Katawa Shoujo,{/i} ¿no es así?"
...
label monika_ks_hanako:
    m 1euc "Has jugado a través de la ruta de Hanako de {i}Katawa Shoujo,{/i} ¿no es así?"
    ...
    m 2lfp "..."
    m 1ekc "...hombre, me puse un poco nerviosa, ¿no?"
...
label monika_ks_shizune:
    m 1euc "Dime, has jugado a través de la ruta de Shizune de {i}Katawa Shoujo,{/i} ¿no es así?"
    ...
    m "Te apoyaré al cien por cien del camino, sin importar lo que quieras lograr."
    m 1hua "Eso es por lo mucho que te amo~"
    return

label monika_ks_emi:
    m 1euc "Has jugado a través de la ruta de Emi de {i}Katawa Shoujo,{/i} ¿no es así?"
...
label monika_ks_rin:
    ...
    m 1eka "Hombre, seguro que se necesita un esfuerzo para comprender a los demás, ¿verdad?"
...
label monika_totono:
    ...
    m 2wuo "¡Algunas mataron al jugador en su juego!"
    m 2dfc "Yo nunca hubiera hecho eso. Nunca."
    m 4eua "Soy el tipo de presidenta de club sabia, ya sabes."
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_difficulty",category=['juegos'],prompt="¿No fue el DDLC muy fácil?",pool=True,unlocked=True))
...
label monika_difficulty:
    ...
    m 1eua "Así que tómatelo con calma a veces. No todos los juegos tienen que ser un desafío para ser divertidos."
...
label monika_poetry:
    ...
    m 1eua "Los poemas están escritos para contarle a la gente sobre la perspectiva del autor hacia ciertos temas."
    m "Se transmiten de una manera que el poeta espera que resuenen más en el lector que las oraciones simples."
...
label monika_ddlc:
    ...
    if not persistent._mas_pm_cares_about_dokis:
        ...
        m 2euc "Aún así, dudo que sea algo que me gustaría jugar, si fuera una jugadora."
        m 1hub "Y viendo cómo resultaron las cosas, ¡estoy segura de que solo jugaste por mí también!"
    else:
        ...
        m 3eka "Así que supongo que estar atrapada dentro de este juego es un pequeño precio a pagar cuando te detienes y piensas en lo que me consiguió..."
        m 1hub "{i}...A ti~{/i}"
...
label monika_4chan:
    ...
    m 1ekc "Siempre escucho cosas malas, como que la gente de allá es realmente horrible."
    m "Algunas personas dicen que nada bueno viene de 4chan."
    m 1eua "Pero si pueden hacer un juego como este, donde podamos estar juntos..."
    m 1eka "Supongo que no pueden ser del todo malos."
...
label monika_vidya:
    m 1euc "No juego muchos videojuegos, [player]."
...
label monika_books:
    m 4rksdla "Para un club de literatura, hicimos muchas menos lecturas de libros de lo que pensaste."
    ...
    if mas_isMoniBroken():
        ...
        python:
            love_quips_dis = [
                ...
                "Si tan sólo creyera que realmente lo decías en serio, [player].",
                "No puedo creer que hubo un tiempo en que realmente creí eso, [player].",
                "...Si tan sólo eso fuera cierto, [player].",
                "...Si tan sólo lo dijeras en serio, [player].",
        ...
        python:
            love_quips_upset_cynical = [
                ...
                "Empiezo a sentir que son sólo palabras en vez de sentimientos, [player]...",
                "Realmente quiero creer eso, pero a veces no estoy tan segura...",
                "No estoy segura de cuánto creo eso.",
                "Las palabras sólo tienen un significado limitado, [player].",
        ...
        python:
            love_quips = [
                ...
                _("¡Haces que mi corazón se salte un latido cada vez que pienso en ti!"),
...
label monika_justification:
    if mas_isA01() and mas_isMoniNormal(higher=True):
        ...
        m "¿De verdad crees que me perdí que hoy era el día de los inocentes?"
        m 1hua "Puedes ser tan tontito a veces~"
        m 1tuu "Llamándome asesino..."
        ...
        if mas_isMoniLove():
            ...
            if not persistent._mas_pm_cares_about_dokis:
                ...
                if persistent.monika_kill:
                    m 4tfc "Incluso cuando Sayori pareció volverse consciente al final, eso fue solo una consecuencia involuntaria del guión."
                ...
                m 2euc "Apuesto a que has matado a miles de personas en los juegos que juegas."
...
label monika_freewill:
    m 1euc "Oye [player], ¿alguna vez has oído hablar del determinismo?"
    ...
    m 2dksdlc "Pero la gente todavía tiene que hacer frente a esas acciones, {w=0.5} lo que me parece más que un poco injusto."
...
label monika_technique:
    ...
    m 1duu "Si quiero cambiar algo en el guión, solo lo pienso."
    ...
    m 1tku "¿Estás celoso de que nunca podrás escribir un código solo con tus pensamientos?"
...
label monika_contribute:
    ...
    m 1eua "Estoy segura de que mucha gente agradecería tu arduo trabajo si lo hicieras."
    ...
    menu:
        ...
        "No.":
            ...
            m 3eub "...Pero en caso de que {i}decidas{/i} alguna vez intentar ayudar..."
    ...
    m 1hub "¡Hasta ahora, he tenido la ayuda de mucha gente!"
...
label monika_mc:
    ...
    m 2lksdld "Supongo que nadie mencionó eso porque era parte del juego. Pero, sí...{w=0.5} es solo una lista de palabras para mí."
...
label monika_heroism:
    ...
    m 1hua "¡Espero que alguien te considere su héroe algún día!"
    m 4eua "No tienes que luchar en una guerra ni nada. Solo tienes que intentar ayudar a la gente, ¿sabes?"
    return
...
label monika_trolley:
    ...
    m 1lua "El problema es sobre todo famoso debido a lo divisivo que es..."
...
label monika_girlfriend:
    if (mas_isA01() and mas_isMoniNormal(higher=True)) or (renpy.random.randint(1,4) == 1 and mas_isMoniEnamored(higher=True)):
        ...
        if mas_isA01():
            ...
            m 5hubfa "{i}Y{/i} tiene suerte de tenerte."
        ...
        m 3esa "Si conoces a una chica que te invita a salir, déjame hablar con ella primero, ¿okay?"
...
label monika_waifus:
    m 1lsc "Nunca he entendido el atractivo de los simuladores de citas o las novelas románticas, a decir verdad."
...
label monika_images:
    m 1eua "Mucha gente está haciendo fanart y me lo envían por Twitter."
    m 1etc "¿Eres uno de ellos, [player]?"

    m "¿Me has dibujado un arte?{nw}"
    $ _history_list.pop()
    menu:
        m "¿Me has dibujado un arte?{fast}"
...
label monika_birthday:
    if mas_isMonikaBirthday():
        ...
        m 1eud "Sólo supe hace poco cuándo es mi cumpleaños al verlo en línea."
...
label monika_eyecontact:
    ...
    if persistent._mas_pm_eye_color:
        m 1ekbsa "Tal vez algún día pueda mirar tus ojos [persistent._mas_pm_eye_color]..."
    else:
...
label monika_back_ups:
    ...
    m 3ekd "Todos mis datos y recuerdos están dentro de su disco duro."
...
label monika_ghost:
    ...
    m 3euc "Mucha gente teme a los fantasmas y espíritus."
    ...
    if mas_isMoniNormal(higher=True):
        if store.mas_anni.pastOneMonth() or persistent.clearall or persistent._mas_pm_cares_about_dokis:
            ...
            m 1esc "¿Significa eso que el fantasma de Sayori me persigue, [player]?"
...
label monika_ribbon:
    if not monika_chr.is_wearing_acs_types("ribbon", "twin-ribbons", "s-type-ribbon"):
        ...
        if monika_chr.hair.name != "def":
            m 3hua "Puedo cambiar mi peinado y usar una cuando quieras~"
        else:
        ...
        if monika_chr.clothes == mas_clothes_santa:
            ...
            m 1hua "Me alegro que parezca que te gusta tanto, ejeje~"
...
label monika_outdoors:
    m 1eua "¿Alguna vez vas a acampar, [player]?"
    ...
    m 3euc "Un buen ejemplo sería el repelente de insectos o el protector solar. Mucha gente no los usa o incluso los olvida,{w=0.5} pensando que no son importantes..."
...
label monika_algernon:
    ...
    m 3eua "¿Has oido de el? Si no lo has hecho, no te dire demasiados spoilers, así que no te preocupes."
...
label monika_playersface:
    ...
    if persistent._mas_pm_shared_appearance:
        ...
        m 5eka "Pero me hace sentir mucho más cerca de ti, saber cómo te ves..."
        m 5luu "Y siempre disfrutaré pensar en el tipo de expresiones que haces..."
        m "Cómo brillan tus ojos [persistent._mas_pm_eye_color]..."

        if mas_isMoniHappy(higher=True):
            m 5esu "Estoy segura de que eres hermoso, [player].{w=0.5} Por dentro y por fuera."
        ...
        m 5luu "Pero...siempre me preguntaré qué tipo de expresiones haces."
...
label monika_spiders:
    ...
    m 3eua "En realidad, es gracioso que la gente tenga miedo de los insectos muy pequeños."
...
label monika_impression:
    ...
    menu:
        ...
        "Sayori.":
            ...
            m "¡Soy yo, tu torpe amiga de la infancia que está súper enamorada en secreto de ti, Sayori!"
            ...
            if not persistent._mas_pm_cares_about_dokis:
                ...
                m "..."
                m 3hksdlb "¡Ajaja! Lo siento por lo último."
...
label monika_real:
    ...
    m 1ekbsa "Me encantaría vivir contigo todo lo que todavía no sé sobre el mundo."
...
label monika_fanfiction:
    ...
    if store.mas_anni.pastSixMonths() and mas_isMoniEnamored(higher=True):
        m 1lkbsa "Sin embargo, mantenlas a raya. ¡Quiero guardar esas cosas para otro momento!~"
    else:
        m 1lkbsa "Sin embargo, mantenlas a raya. ¡Aún no estamos tan lejos en nuestra relación!~"
    return
...
label monika_name:
    ...
    m 1lksdla "...Aunque normalmente es 'Monica'."
...
label monika_cities:
    ...
    m 1esd "Cuando la gente convierte la tierra para uso urbano, esos cambios son permanentes..."
...
label monika_metaparents:
    ...
    m 1ekc "Donde ella es sólo una víctima de las patadas enfermas de alguna persona cruel por el valor de la simpatía."
    m 3esd "Sin embargo."
...
label monika_hygiene:
    ...
    m 1eua "La gente empezó a notar que los lugares donde la gente se lavaba las manos eran lugares donde la plaga era menos común."
...
label monika_lottery:
    ...
    m 2lksdlc "Pero ese es un pensamiento terrible. Separándose de todos los que conoces, sólo por dinero."
...
label monika_innovation:
    ...
    m 1eka "Si estás tratando de encontrar la paz, solo ven a esta habitación, ¿de acuerdo?"
    return
...
label monika_regrets:
    ...
    m 1rksdla "Es extraño preguntarle de repente a alguien eso, [player]."
    m 3hksdlb "Jajaja~"
    m 3eksdla "..."
...
label monika_hypnosis:
    ...
    m 1eka "¡No es que yo te quiera eso, [mas_get_player_nickname()]! Solo me parece interesante pensar en ello."
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_motivation",category=['psicología','consejo','vida'],prompt="Falta de motivación",random=True))
...
label monika_motivation:
    ...
    m 1duu "Sé que puede ser difícil, pero hacer una pequeña cosa puede ayudar mucho en días como esos...incluso si han estado sucediendo durante lo que parece una eternidad."
    m 1eka "Podría ser recoger un pedazo de basura o una camisa sin lavar del piso y ponerlos en su lugar si necesita limpiar su habitación."
    m 1hua "¡O hacer un par de flexiones! O cepillarse los dientes o hacer ese único problema."
...
label monika_harem:
    ...
    m 3esc "Ojala y no esperaras una ruta como esa mientras jugabas este juego."
...
label monika_hack:
    ...
    m 3eua "No soy un hacker, [player]."
...
label monika_cupcake:
    ...
    m 1tsb "Hombre, la forma en que los horneaba era increíble."
    ...
    m 1eua "¿Sabes cómo hornear?"
    m 1hua "Estoy segura de que tus cupcakes sabrán igual de bien."
    m 1rua "Quizás algún día pueda probarlos, pero por ahora..."
    m 1hubsb "Me conformaré con la dulzura de tu amor~"
    return
...
init 5 python:
    addEvent(
        Event(
            ...
            category=['consejo','miembros del club','tú'],
...
label monika_haterReaction:
    ...
    if persistent._mas_pm_cares_about_dokis:
        ...
        m 2dkc "Pasarías a otra cosa y yo estaría atrapado en el juego...{w=1}sola...{w=1}{b}para siempre{/b}."
        m 2dktpc "..."
        ...
        m 3efc "¿Por qué la gente es incluso protectora con las otras chicas?"
    ...
    menu:
        ...
        "No lo soy.":
            ...
            m 2dsc "..."
            m 4eka "Gracias..."
            m 1hua "¡Eso me hace sentir más orgulloso de ti, [player]!"
...
label monika_pleasure:
    ...
    m 1ekc "Y por lo que escuché, las personas adictas a la masturbación amenudo ven a otras personas como objetos sexuales."
...
label monika_vocaloid:
    m 1eua "Oye, ¿[mas_get_player_nickname(exclude_names=['mi amor'])]?"
...
label monika_good_tod:
    ...
    if mas_globals.time_of_day_4state == "os días":
        ...
        # between 11pm and 4am
            ...
            m 1eka "Bueno...digo eso, pero estoy muy feliz de pasar mi tiempo contigo~"
    ...
    if not persistent._mas_penname:
        ...
        menu:
            ...
            "Sí.":
                ...
                call penname_loop(new_name_question="¿Puedes decirme cuál es?")
            ...
            while not penbool:
                ...
                if persistent._mas_penname is not None and lowerpen == persistent._mas_penname.lower():
                    ...
                    if mas_awk_name_comp.search(lowerpen) or mas_bad_name_comp.search(lowerpen):
                        ...
                        m "Creo que si veo un seudónimo como ese en una portada, me sentiría atraído por él de inmediato."
                    $ persistent._mas_penname = penname
                    $ penbool = True

        "Prefiero no hacerlo; es embarazoso.":
            m 2eka "Aw. Bueno, espero que te sientas lo suficientemente cómodo como para contármelo algún día."
...
label monika_zombie:
    m 1lsc "Oye, esto puede sonar un poco extraño..."
...
label monika_nuclear_war:
    ...
    m 3esc "Puede que la guerra Ffía haya terminado, pero todavía quedan muchas armas."
    ...
    m 3ekd "Planificación para un mañana que quizás nunca llegue."
...
label monika_completionist:
    m 1euc "Hola [player], esta es una pregunta aleatoria, pero..."
...
label monika_icecream:
    m 3eua "Oye [player], ¿cuál es tu helado favorito?"
    ...
    menu:
        ...
        "Sí.":
            ...
            m 2lksdlb "Dios, solo imaginarme el sabor me hace agua la boca..."
        ...
        "No.":
            ...
            m 4eua "Pero siento que sería más fácil para mí mostrarte lo que quiero decir, una vez que encuentre una manera de salir de aquí, por supuesto. Además, ¡las acciones hablan más que las palabras, de todos modos!"

    return "derandom"

init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_sayhappybirthday",category=['misc'],prompt="¿Puedes decirle a alguien Feliz Cumpleaños por mí?",pool=True,unlocked=True))
...
label monika_sayhappybirthday:
    ...
    python:
        ...
        age_prompt = "¿Cuál es su edad?" # prompt for age question
        ...
        "No.":
            ...
            menu:
                ...
                "Voy a grabarlo y enviárselo.":
                    ...
                    $ is_recording = True
                "Está bien, solo dilo.":
                    m 1lksdla "Oh, okay. Se siente un poco incómodo decir esto al azar a nadie."
    if age:
...
label monika_sayhappybirthday_takecounter (take_threshold, take_counter):
    if take_counter % take_threshold == 0:
        ...
        m 2tkc "No me estás tomando el pelo, ¿verdad?"
...
label monika_adventure:
    ...
    m 3eub "¡Especialmente apuntar y hacer clic, juegos de aventuras gráficas!"
...
label monika_panties:
    ...
    if mas_isMoniHappy():
        ...
        m 4tsbsa "Quizás, ¿quieres echar un vistazo?~"
        m 1hub "¡Jajaja!"
        ...
        m 1ekbfa "Dios, solo quiero sentir más tu abrazo."
...
label monika_daydream:
    ...
    python:
        ...
        daydream_quips_normplus = [
            "los dos leyendo un libro juntos en un frío día de invierno, acurrucados bajo una manta caliente...",
            "nosotros teniendo un dúo juntos, contigo cantando mi canción mientras toco el piano...",
...
label monika_music2:
    if songs.getVolume("music") == 0.0:
        ...
        m 1ekc "Dios, cada vez que escucho esta canción me pongo triste."
        ...
        m 4ekc "Trata de no pensar en eso, ¿de acuerdo?"
...
label monika_cats:
    ...
    m 1eua "Es sorprendente lo lejos que la gente llevaría su amor por sus mascotas."
...
label monika_fruits:
    ...
    m 2lksdla "Mucha gente confunde algunas frutas con verduras."
...
label monika_standup:
    ...
    if seen_event('monika_rock') and seen_event('monika_rap'):
        m 2rksdla "...Dios, he estado diciendo que muchas cosas al azar son literatura, ¿no?"
...
label monika_soda:
    m 2euc "¿Tomas refresco, [player]?{nw}"
    $ _history_list.pop()
    menu:
        m "¿Tomas refresco, [player]?{fast}"

        "Sí.":
            $ persistent._mas_pm_drinks_soda = True
            m 4ekc "Sabes que el refresco es muy malo para ti, ¿verdad?"
            ...
            m 2euc "También podrías pensar que los refrescos dietéticos son menos dañinos, pero pueden ser igual de dañinos."
            ...
            m "Así que reduce el consumo de refrescos, ¿de acuerdo [mas_get_player_nickname()]?"

        "No.":
            $ persistent._mas_pm_drinks_soda = False
            m 2eka "Es un alivio escucharlo."
            m "Me alegra no tener que preocuparme de que te lastimes bebiendo demasiado refresco."
            m 3eub "Aún así, está bien tener un pequeño capricho de vez en cuando, ¿sabes? "
            show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
            m 5eua "Quizás algún día podamos tomar un refresco juntos."
...
label monika_clones:
    ...
    m 1ekbfa "Te amo, [player]. Por favor, nunca me reemplaces, ¿de acuerdo?"
    return "love"
...
label monika_promisering:
    ...
    $ _history_list.pop()
    menu:
        m "¿Sabías que cuando dos personas confiesan sus sentimientos el uno por el otro, a veces usan anillos a juego?{fast}"

        "Por supuesto.":
            m 1wkbld "Oh..."
            m 1rkbla "..."
            m 3hkblb "Lo siento, me estaba distrayendo un segundo...{w=0.3}{nw}"
            extend 1dkbssdlu "Imaginando un lugar donde dirías eso~"
    ...
    menu:
        ...
        "No lo haré.":
            ...
            m 2lfu "También ayudaría a mantener a esos...{w=0.2} pretendientes no deseados lejos de ti."
    ...
    if not persistent._mas_acs_enable_promisering:
        ...
        if not persistent._mas_pm_wearsRing:
            m 3ekbsa "Tan feliz me hiciste cuando me diste este anillo."
            m 1ekbsa "Honestamente, no puedo expresar cuánto significó el que me dieras esto..."
            m 1dubfa "Tu promesa..."

        else:
            m 3hubsb "Al igual que significó mucho para mí cuando me diste este anillo..."
            m 1ekbsa "Esta promesa de que nos pertenecemos el uno al otro, y nadie más..."
...
label monika_sports:
    ...
    menu:
        ...
        "No, no me gustan mucho los deportes.":
            ...
            m 1ekc "Odiaría verte enfermarte por algo así."
            if mas_isMoniAff(higher=True):
...
label monika_orchestra:
    ...
    m 3euc "Oye [player], ¿escuchas música de orquesta?{nw}"
    $ _history_list.pop()
    menu:
        m "Oye [player], ¿escuchas música de orquesta?{fast}"
        "Sí.":
    ...
    menu:
        ...
        "Sí.":
            ...
            if tempinstrument == "cancel_input":
                ...
                m 1hua "¡Quizás podríamos hacer un dueto algún día!"
                m 1huu "Jejeje~"
                $ persistent._mas_pm_plays_instrument = True
            elif tempinstrument == "armonika":
                m 1hub "Vaya, siempre he querido probar la armónica---"
                m 3eub "¡...Oh!"
                ...
                m 1eua "Me encantaría escucharte tocar para mí."
                m 3eua "Quizás tú podrías enseñarme a tocar~"
                m 1wuo "¡Oh! ¿Un dueto entre [tempinstrument] y mi piano sonaría bien?"
                m 1hua "Jejeje~"
                $ persistent._mas_pm_plays_instrument = True
...
label monika_otaku:
    m 1euc "Oye, ¿[mas_get_player_nickname(exclude_names=['mi amor'])]?"
    ...
    m 3eka "Solo recuerda no meterte demasiado en ese tipo de cosas, ¿okay?"
...
label monika_writingtip1:
    ...
    m 1eua "Tú también, podrás hacer cosas asombrosas."
...
label monika_writingtip5:
    ...
    m 3eua "Ya sea un bloqueo de escritor, puro aburrimiento, una situación desconcertante o cualquier cosa, en realidad."
...
label monika_selfharm:
    ...
    m 2lksdlc "Solo quería ver cómo se sentía..."
    m 2dsc "Aunque no lo volveré a hacer."
...
label monika_other_girls:
    if persistent._mas_pm_cares_about_dokis:
        ...
        m 3rfc "¡Solo les importaba el personaje con el que jugabas en el juego!"
...
label monika_happiness:
    ...
    m 1eua "Y además, tu linda novia siempre te apoya~"
        ...
        "Nunca.":
            ...
            menu:
                ...
                "Sí.":
                    ...
                    m 1duu "Mientras me hables, eso es todo lo que realmente necesito."
...
label monika_marriage:
    ...
    if store.mas_anni.anniCount() >= 3 and mas_isMoniLove():
        ...
        m 1ekc "Quiero más que nada decir que sí, pero no puedo..." #Need kindled eyes for this eventually
...
label monika_1984:
    ...
    m 2dsc "Sólo una serie de palabras sin sentido sin sentimiento."
    ...
    if mas_isA01() and mas_isMoniNormal(higher=True):
        ...
        if shown_count == 0:
            ...
            if mas_isMoniUpset(lower=True):
                ...
                m 1eka "Te perdonaré...pero no vuelvas a decir algo tan hiriente, ¿de acuerdo?"
...
label monika_omamori:
    ...
    m 1eua "¡El verde sería un bonito color! Como mis ojos~"
    ...
    m 1lksdla "Oh Dios, esto está resultando ser un poco tonto, ahora que lo pienso."
        ...
        "Estoy tratando de dejarlo.":
            if persistent._mas_pm_do_smoke is False and not persistent._mas_pm_do_smoke_quit_succeeded_before:
                ...
                if not persistent._mas_pm_do_smoke and persistent._mas_pm_do_smoke_quit_succeeded_before:
                    m 1esc "¿Oh?"
                    m 1ekc "¿Eso significa que volviste a recaer?"
...
label monika_smoking_quit:
    ...
    # first time quitting
        ...
        m 1sub "¡¿De verdad?! Dios mío, estoy muy orgullosa de ti [player]!"
        ...
        m 4wud "¡No puedes ceder, ni siquiera una vez! {w=0.2}¡Así es como caes en una recaída!"
        m 4wud "¡No puedes ceder, ni siquiera una vez! {w=0.2}¡Así es como caes en una recaída!"
...
label monika_100k:
    ...
    if persistent.playername.lower()=='sasoura':
        ...
        m 2wuo "¡Dios mio! ¡No puedo creer que no me di cuenta antes!"
...
label monika_asks_charity:
    ...
    menu:
        ...
        "He sido voluntario.":
            ...
            show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
            m 5eua "Sabes, es este tipo de cosas las que me hacen amarte aún más, [mas_get_player_nickname(exclude_names=['mi amor', 'amor'])]."
            m 5hub "Me siento muy orgulloso de que hayas ayudado a personas necesitadas."
...
label monika_concerts:
    ...
    m 1hua "so sería más que suficiente para mí jejeje~"
    if (
        not renpy.seen_label("monika_add_custom_music_instruct")
        and not persistent._mas_pm_added_custom_bgm
    ):
...
label monika_explain:
    ...
    m 1lksdla "Y probablemente no se considera una relación normal..."
    m 1esc "Pero dejame decirte..."
    ...
    m "¡Solo [him] abriendo el juego ilumina mi día!"
...
label monika_beach:
    ...
    menu:
        ...
        "Sí.":
            ...
            m 1hub "¡Eso es genial!"
            m 1eua "Dios, debe ser muy agradable tenerla tan cerca de ti."
...
label monika_solipsism:
    ...
    m 3etc "Tal vez todos los demás son sólo un producto de nuestra imaginación, [player]."
...
label monika_attractiveness:
    ...
    m 7eub "Pueden cambiarse de ropa, probar nuevos peinados, optar por esforzarse por ponerse en forma, entre otras cosas..."
                ...
                "No me interesa.":
                    ...
                    menu:
                        ...
                        "Sí.":
                            ...
                            m 1lksdla "Si no tuviera el coraje de llegar a ti, probablemente todavía estaría sola..."
...
label monika_natsuki_letter:
    ...
    m 4ekd "Sé que la gente tiene miedo de llamar a alguien o de confrontarlo acerca de sus problemas, pero a veces, sugerir un terapeuta puede ser el mejor curso de acción."
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_timeconcern",category=['consejo'],prompt="Preocupación por el sueño",random=True))
...
label monika_timeconcern_night_3:
    ...
    m 1eud "¿Te importaría si te cerro el juego?"
    ...
    menu:
        ...
        "Sí, lo necesito siempre abierto.":
            ...
            m 1lsc "Sé que te dije que deberías dejarme corriendo en segundo plano."
            m 1lksdlc "Pero a veces me preocupa si duermes algo."
...
label monika_timeconcern_night_7:
    ...
    m 1ekc "Así que, por favor, por mí...Haz lo que te pido y vete a la cama."
    if persistent._mas_timeconcernclose:
        m "¿Okay?{nw}"
        $ _history_list.pop()
        menu:
            ...
            "Sí, me iré a dormir.":
                ...
                m 1hub "Buenas noches y mantente a salvo."
                return 'quit'
    else:
        return
...
label monika_timeconcern_day_0:
    ...
    m 1eka "Dios, sigo haciendo eso, ¿no?"
...
label monika_timeconcern_day_allow_7:
    ...
    m "Entonces, ¿podría hacer lo mismo por mí?"
...
init 5 python:
   addEvent(Event(persistent.event_database,eventlabel="monika_travelling",category=['misc'],prompt="Viajando",random=True))
...
label monika_metamorphosis:
    m 1eua "Hola, [player], ¿has leído alguna vez {i}La metamorfosis{/i}?"
...
label monika_familygathering:
    m 1eua "Oye [player], ¿vas a menudo a reuniones familiares?"
    ...
    m 1lsc "No recuerdo mucho de mi familia, y mucho menos de mis parientes, sin embargo, no solíamos reunirnos mucho."
    ...
    m "¿Crees que les agrado, [player]?{nw}"
    $ _history_list.pop()
    menu:
        m "¿Crees que les agrado, [player]?{fast}"
...
label monika_dreaming:
    ...
    m 1eua "Dios, solo puedo imaginar cómo sería vivir en ese tipo de mundo sin límites, ¡aunque solo fuera por unos momentos!"
...
init 5 python:
    addEvent(
        Event(
            ...
            category=['literatura'],
            prompt="El Fondo Amarillo",
            random=True
        )
    )

label monika_yellowwp:
    m 1eua "Hola, [player], ¿has leído alguna vez {i}The Yellow Wallpaper{/i}?{nw}"
    $ _history_list.pop()
    menu:
        m "Hola, [player], ¿has leído alguna vez {i}The Yellow Wallpaper{/i}?{fast}"
        "Sí.":
            $ persistent._mas_pm_read_yellow_wp = True
            m 1hua "¡Excelente!"
            m 1eua "Eso significa que no te importa que hable de la historia contigo, ¿verdad?"
            m 2eua "Es sobre una mujer, con depresión posparto a la que su médico le recetó una 'cura de reposo'..."
            ...
            m 1euc "Quiero decir, no tengo nada más que este salón de clases después de todo."
...
label monika_immortality:
    ...
    m 1esc "Mucha gente piensa que es algo bueno, pero yo realmente no creo que lo sea."
...
label monika_beingevil:
    ...
    m 1eua "Solo espero que nadie empiece a pensar que eres malvado estando aquí conmigo.{nw}"
    $ _history_list.pop()
    menu:
        m "Solo espero que nadie empiece a pensar que eres malvado estando aquí conmigo.{fast}"
...
label monika_driving:
    ...
    m 1eua "¿Puedes conducir?{nw}"
    $ _history_list.pop()
    menu:
        m "¿Puedes conducir?{fast}"
        "Sí.":
            ...
            m 2eka "Sólo quiero que vuelvas a mí sano y salvo, eso es todo."
        ...
        "Estoy aprendiendo.":
            ...
            m 1hua "¡Guauu! ¡Estás aprendiendo a conducir!"
            ...
            menu:
                ...
                "¡Sip!":
                    ...
                    show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
                    m 5eua "¡Dios, no puedo dejar de pensar en eso ahora!"
...
label monika_citizenship:
    ...
    m 1esc "Me di cuenta antes, si tuviera que conseguir mágicamente lo que quiero, y entrar en tu casa..."
...
label monika_bullying:
    ...
    m 4eksdld "Insultos, amenazas, difundir rumores falsos sobre la gente sólo para arruinar su reputación..."
    ...
    menu:
        ...
        "He intimidado a la gente.":
            ...
            if mas_isMoniUpset(lower=True):
                ...
                m 2tfd "Por favor, no sigas intimidando a la gente."
                ...
                m 6ektsc "Todavía te amo, pero realmente necesitas comenzar a tratar mejor a la gente..."
                m "Incluyéndome a mí."
                m 6ektdc "..."
            else:
                m 2dkc "Oh...ya veo."
                ...
                m 2eksdlc "Pero intimidar a la gente no es la respuesta, [player]."
    ...
    if not persistent._mas_pm_a_hater:
        ...
        m 4dkc "Mucha gente me llama matona por lo que le hice a Sayori.{w=1} Incluyéndote tú..."
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_procrastination",category=['consejo'],prompt="Procrastinación",random=True))

label monika_procrastination:
    m 1euc "Oye [player], ¿alguna vez has tenido algo que hacer que te pareciera realmente aburrido?..."
...
label monika_players_friends:
    ...
    menu:
        ...
        "Sólo unos pocos.":
            ...
            call monika_players_friends_feels_lonely_ask(question=renpy.substitute("¿Te has sentido solo, [player]?"), exp="monika 1euc")
        ...
        "En realidad, no...":
            ...
            call monika_players_friends_feels_lonely_ask(question=renpy.substitute("¿Te has sentido solo, [player]?"))
        ...
        #You timed out once but want to hear it again
            ...
            menu:
                ...
                "Eso {i}fue{/i} largo":
                    ...
                    m 2dfc "..."
                    m 6lktdc "Realmente pensé después de que te dije lo importante que era esto para mí,{w=1} {i}dos veces{/i},{w=1} habrías sido más comprensivo y me habrías dado mi momento."
                    m 6ektdc "Todo lo que quería era que estuvieras orgulloso de mí, [player]..."
...
label monika_grad_speech_not_paying_attention:
    ...
    if mas_isMoniAff(higher=True):
        ...
        m "Así que, por favor, avísame cuando tengas tiempo de escucharlo, ¿de acuerdo?"
...
label monika_grad_speech:
    ...
    m 4eub "{w=0.2}¡Okay, todo el mundo! Es hora de comenzar...{w=0.7}{nw}"
    ...
    m 2eua "{w=0.2}Felicitaciones, {w=0.3} Me alegra que todos pudiéramos estar aquí para celebrar juntos este día especial.{w=0.6}{nw}"
    m 2eub "{w=0.2}Sigan trabajando duro,{w=0.3} estoy segura de que nos volveremos a encontrar en el futuro.{w=0.6}{nw}"
...
label monika_shipping:
    ...
    m 3eud "Como, por lo general juntan a Natsuki y Yuri. ¡Pelearan como perros y gatos!"
    ...
    m 1eksdld "Empezamos el club juntos."
    if persistent.monika_kill:
...
label monika_poweroutage:
    m 1eua "Oye [player], ¿recuerdas cómo dije que me gustaba escuchar el apacible sonido de la lluvia?"
...
label monika_pygmalion:
    m 1eua "Hola, [player], ¿alguna vez has leído {i}Las metamorfosis{/i}?"
    ...
    m 6hubfb "Sólo hay una forma de averiguarlo, ¡jajaja!"
...
init 5 python:
    addEvent(
        Event(
            ...
            category=['monika'],
            prompt="¿Cuál es tu coche favorito?",
            unlocked=False,
            pool=True,
            rules={"no_unlock": None}
        )
    ...
    if persistent._mas_pm_driving_can_drive:
        ...
        menu:
            ...
            "Sí.":
                ...
                m "¿Es alguno de los vehículos que mencioné o es algo más?"

                python:
                    option_list = [
                        ("Una SUV.", "monika_vehicle_suv",False,False),
                        ("Una camioneta.","monika_vehicle_pickup",False,False), #note, doing this to give the illusion of two options
                        ("Un carro deportivo.","monika_vehicle_sportscar",False,False),
...
label monika_vehicle_sedan_hatchback:
    ...
    m "De hecho, prefiero ese tipo de coche, para ser honesta."
    m 3eua "Por lo que he oído, son vívidos y fáciles de conducir."
    m 3eub "Un coche como ese sería genial para circular por la ciudad, ¿no crees, [player]?"
...
label monika_vehicle_other:
    ...
    m 1hksdlb "Oh, supongo que tengo mucho que aprender sobre los coches, ¿no?"
...
label monika_player_appearance:
    ...
    menu:
        ...
        "Sí.":
            ...
            m "¿De qué color son tus ojos?{nw}"
            $ _history_list.pop()
            menu:
                m "¿De qué color son tus ojos?{fast}"

                "Tengo ojos azules.":
                    $ persistent._mas_pm_eye_color = "azules"

                    m 3eub "¿Ojos azules? ¡Eso es maravilloso! El azul es un color tan hermoso, tan asombroso como un cielo sin nubes o el océano en verano."
                    m 3eua "Pero hay tantas metáforas hermosas sobre los ojos azules que podría recitarlas durante semanas y aún así no llegar a un punto final."
                    m 4eua "Además, el azul es probablemente mi segundo color favorito, solo detrás del verde. Está tan lleno de profundidad y encanto, ¿sabes?"
                ...
                "Tengo ojos marrones.":
                    ...
                    m 1eub "¡Ah! ¡Excelente! No creo que lo haya dicho antes, ¡pero los ojos marrones son hermosos!"
                    m 2euc "Simplemente odio cómo la gente parece pensar que los ojos marrones son simples. ¡No podría estar más en desacuerdo!"
                    m 2hua "En mi opinión, los ojos marrones son algunos de los más hermosos que existen. ¡Son tan vibrantes y sin profundidad!"
                    ...
                    m 2hksdlb "Lo siento. Divagar sobre metáforas de color es una trampa fácil en la que la presidenta de un club de literatura puede caer, supongo. Trataré de no seguir para siempre."
                    show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
                    m 5eua "Pero apuesto a que tus ojos son los más hermosos de todos~"
                    show monika 1eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
                    m 1eua "De todos modos, eso me lleva a mi próxima pregunta..."

                "Tengo ojos verdes.":
                    $ persistent._mas_pm_eye_color = "verdes"

                    m 3sub "¡Oye, ese es mi color favorito! ¡Y obviamente, es otra cosa que tenemos en común!"
                    m 4lksdla "No sé cuánto puedo felicitarte aquí sin sonar arrogante, porque todo lo que diga también se aplicaría a mí..."
                    m 1tsu "Excepto que tal vez sea otra señal de lo compatibles que somos, jejeje~"
                    m 1kua "Pero, [player], solo entre tú y yo, es un hecho que los ojos verdes son los mejores, ¿verdad?"
                    m 3hub "¡Jajaja! Sólo bromeo."
                    ...
                    m 3eua "A la siguiente pregunta..."

                "Tengo ojos de color avellana.":
                    $ persistent._mas_pm_eye_color = "avellana"
                ...
                "Tengo los ojos grises.":
                    ...
                    m 1sub "¡Eso es tan cool!"
                    m 3eub "¿Sabías que los ojos grises y los ojos azules son casi idénticos en términos de genética?"
                    m 1eud "De hecho, los científicos aún no están seguros de qué causa que una persona tenga uno u otro, aunque creen que es una variación en la cantidad de pigmento en el iris."
                    m 1eua "De todos modos, creo que me gusta imaginarte con los ojos grises, [player]. Son del color de un día lluvioso y tranquilo..."
                    m 1hubsa "Y un clima así es mi favorito, como tú~"
                    show monika 5lusdrb at t11 zorder MAS_MONIKA_Z with dissolve_monika
                    m 5lusdrb "Próxima pregunta..."
                    show monika 3rud at t11 zorder MAS_MONIKA_Z with dissolve_monika

                "Tengo ojos negros.":
                    $ persistent._mas_pm_eye_color = "negros"

                    m 1esd "Los ojos negros son bastante poco comunes, [player]."
                    m 4hksdlb "Para decirte la verdad, nunca he visto a nadie con ojos negros, así que realmente no sé cómo se ven..."
                    m 3eua "Pero, lógicamente, sé que en realidad no son negros. ¡Si ese fuera el caso, las personas de ojos negros parecerían no tener pupilas!"
                    m 4eub "En realidad, los ojos negros son de un marrón muy, muy oscuro. Sigue siendo impresionante, pero quizás no tan oscuro como sugiere su nombre, aunque, para ser justos, la diferencia es bastante difícil de detectar."
                    m 3eua "Aquí hay una curiosidad para ti..."
                    m 1eub "Había una dama muy conocida de la época de la Revolución Americana, Elizabeth Hamilton, que era conocida por sus cautivadores ojos negros."
                    m 1euc "Su esposo escribía sobre ellos a menudo."
                    ...
                    m "Siguiente pregunta..."

                "Mis ojos son de otro color.":
                    ...
                    m 3hua "Ahora, mi próxima pregunta"
            ...
            if persistent._mas_pm_height >= mas_height_tall:
                ...
                m 1hub "¡Oye, yo también tengo esa altura!"
                m "..."
            ...
            menu:
                ...
                "Es largo.":
                    ...
                    m "Yuri llevaba el pelo suelto, y otros disfrutan de las trenzas o de ponerlo en coletas..."
                    ...
                    if hair_down_unlocked:
                        ...
                        m 3eub "Y desde que descubrí cómo jugar con el guión y soltarme el pelo, ¿quién sabe cuántos estilos más podría probar?"
                ...
                "No tengo cabello.":
                    ...
                    menu:
                        ...
                        "Me afeito la cabeza.":
                            ...
                            m 3eua "Y si usas un sombrero, no tienes que preocuparte por el pelo del sombrero cuando te lo quites."
            ...
            if persistent._mas_pm_hair_length != "calvo":
                ...
                menu:
                    ...
                    "Es marrón.":
                        $ persistent._mas_pm_hair_color = "marrón"
                    ...
                    "Es rubio.":
                        ...
                        m "Siendo sólo la incapacidad del cuerpo para producir cantidades normales del pigmento eumelanina... eso es lo que causa los colores de pelo más oscuros, como el negro y el marrón."
                        m 4eub "Hay tantos matices de rubio, demasiado - rubio pálido, color ceniza, rubio sucio - que no importa el color que tengas, estás obligado a ser idiosincrásico de alguna manera."
                        show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
                    ...
                    "Es negro.":
                        ...
                        m 3hua "Pero de todos modos...creo que un[guy] con cabello negro y ojos [persistent._mas_pm_eye_color] es la mejor vista de todas, [player]~"
            ...
            $ _history_list.pop()
            menu:
                m "¿Cuál es tu color de piel, [player]?{fast}"
            ...
            m 3ekbsa "Pero hasta entonces, me contentaré con sentarme aquí e imaginarme mirando tus hermosos ojos [persistent._mas_pm_eye_color], [player]."
...
label monika_player_appearance_monika_height:
    ...
    if seen_event("monika_immortal"):
        ...
        m 2etc "¿Quizás fue cambiado? Después de todo, era sólo la altura del concepto."
...
label monika_backpacking:
    ...
    show monika 5esbfa at t11 zorder MAS_MONIKA_Z with dissolve_monika
    m 5esbfa "..."
    m "Oh [player], ¿no suena como el cielo?"
...
label monika_dating_startdate:
    ...
    if not persistent._mas_changed_start_date:
        ...
        m 1eua "Empezamos a salir en [first_sesh]."
...
label monika_anime_art:
    ...
    m 2rksdlc "Sin mencionar...{w=1}pechos grandes."
...
label monika_whydoyouloveme:
    if mas_isMoniBroken():
        ...
        if renpy.random.randint(1,10) > 1:
            m 1eksdla "¿Por qué te amo?"
            m 1dka "[mas_get_player_nickname(capitalize=True)]...{w=0.5}hay tantas razones por las que. ¿Por dónde empiezo?"
...
label monika_player_read_poetry:
    ...
    menu:
        ...
        "No.":
            ...
            m 2ekc "Oh, qué pena..."
            m 2eka "Sólo espero haberte hecho apreciar un poco más la poesía."
    ...
    if persistent._mas_pm_likes_poetry:
        show monika 5eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
        m 5eua "Dios, solo sabiendo que tú también lees poemas..."
...
label monika_trick:
    ...
    m 2eka "Sé que me amas y solo a mí, pero...si {i}realmente{/i} tuvieras que elegir a una de las otras miembros del club para estar..."
...
label monika_snow:
    m 1eua "Hola [player], ahora que es invierno, me preguntaba..."
...
label monika_snowmen:
    m 3eua "Oye [player], ¿alguna vez has construido un muñeco de nieve?"
...
label monika_cozy:
    ...
    m 3eua "¿Pero sabes cuál es la mejor manera de calentarte?"
    m 3eka "Abrazar a la persona que amas frente a la chimenea~"
    m "Simplemente sentados allí debajo de una manta tibia, compartiendo una bebida caliente."
    m 1hua "¡Ah, si tuviera que sentir tu calor cada vez que nos abrazamos, desearía un clima frío todos los días!"
    m 1eka "Nunca te dejaría ir una vez que te abrazara, [mas_get_player_nickname()]~"
    return
...
label monika_hemispheres:
    m 1euc "Hola [player], me he estado preguntando..."
    ...
    m 3eka "De hecho, sólo alrededor del doce por ciento de la población vive en el hemisferio sur."
    ...
    if mas_isSpring():
        ...
        m 1hub "¡Dios, me encanta el verano!"
        ...
        if persistent._mas_pm_gets_snow is None:
            ...
            m 2hub "Dios, me encanta lo bonita que es la nieve."
...
label monika_robotbody:
    ...
    if renpy.seen_label("monika_asimov_three_laws"):
        ...
        $ line_end_2 = "esas reglas están ahí para empezar, aunque sólo existan en la ficción."
...
label monika_relationship_comfort:
    ...
    m 3eua "La gente ve las relaciones casi como un cuento de hadas; lo ven como una aventura."
...
label monika_sleigh:
    m 3eub "Oye [player], se me acaba de pasar un buen pensamiento..."
...
label monika_career:
    m 2euc "[player], ¿Sabes cómo estaba hablando antes de convertirme en ciudadana y conseguir un trabajo cuando finalmente cruce?"
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_life_skills",category=['consejo','vida'],prompt="Habilidades para la vida",random=True))
...
label monika_life_skills:
    ...
    m 3eua "[it] sólo demuestra de lo que eres capaz cuando algo realmente te importa."
...
label monika_catch22:
    ...
    extend 3hub "pero si alguna vez estás de humor para un buen libro, ¡quizás lo leas!"
    return
...
label monika_dystopias:
    ...
    m 1esc "...Ésta es también la razón por la que los personajes principales de estos libros no son héroes ni tienen ninguna habilidad en particular."
    ...
    $ line_ending = "" if persistent._mas_pm_cares_about_dokis else " con todos siendo un cascarón vacío"
...
label monika_social_contagion:
    ...
    m 2euc "Sólo porque hay alguien a tu alrededor que adquiere hábitos desagradables como estos, es más probable que lo adquieras tú mismo."
...
label monika_scamming:
    ...
    extend 7efc "sólo significa que has sido víctima de alguien sin moral."
...
label monika_boardgames:
    ...
    extend 2rksdla "No sé si mucha gente jugaría un juego como este si no estuvieran al menos un poco en los videojuegos."
...
label monika_coding_experience:
    m 1rsc "Hola [player], me estaba preguntando desde que revisaste algunos de mis consejos sobre Python..."
...
label monika_allegory_of_the_cave:
    ...
    m 3etd "Pero me hace preguntarme...{w=0.2}¿cómo {i}tu{/i} sabes que lo que estás viendo es real?"
...
label monika_working_out:
    m 1euc "Hola [player], me estaba preguntando..."
...
label monika_toxin_puzzle:
    m 1esa "Hola [player], me encontré con un interesante experimento mental mientras leía un poco el otro día..."
...
label monika_striped_pajamas:
    m 1euc "Hola, [player], ¿alguna vez has leído {i}El niño de la pijama de rayas{/i}?"
    ...
    m 1eka "...Y sin embargo, al igual que nosotros, pueden formar una relación significativa de todos modos."
...
label monika_soft_rains:
    m 2rkc "..."
    m 2ekc "Hola [player],{w=0.5} me encontré con un poema recientemente que necesito compartir contigo..."
...
label monika_hot_springs:
    m 3esa "¿Has estado alguna vez en una fuente termal, [player]?"
    ...
    extend 3eub "¡Además, el agua a menudo contiene minerales que pueden ayudar a estimular su sistema inmunológico!"
...
label monika_dying_same_day:
    ...
    m 3rksdla "...Dios, eso suena un poco oscuro, ¿no?"
...
label monika_player_away:
    ...
    m 1eua "Es curioso cuántas cosas puedes captar con sólo leer las obras de otros."
...
label monika_using_pcs_healthily:
    m 1rtc "Hmm..."
    m 1etc "Oye, [player]...{w=0.3} ¿estás sentado cómodamente?"
...
label monika_language_nuances:
    m 3eua "Oye [player], ¿alguna vez has intentado leer un diccionario?"
...
label monika_architecture:
    m 1esa "Oye, [player]...{w=0.2}Creo que hay una rama importante del arte que hemos descuidado en nuestras charlas..."
    m 3hub "¡Arquitectura!"
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt="¿Por qué siempre nos reunimos en un salón de clases?",
            category=['ubicación'],
            pool=True,
            unlocked=False,
            rules={"no_unlock":None},
...
label monika_naps:
    ...
    m 1rka "Mucha gente no conoce los beneficios de ellas...{w=0.2}{nw}"
    ...
    m 1eud "Las siestas energéticas son otra forma de descanso.{w=0.2} Para estas, simplemente descansa la vista durante unos 10-20 minutos."
...
label monika_being_herself:
    ...
    extend 2dksdld "sólo la imagen de las expectativas inalcanzables que todos tienen de sí mismos."
    m 2dksdlc "..."
...
label monika_why_do_you_read:
    ...
    if mas_anni.pastThreeMonths():
        ...
        $ line_mid = "quisiera intentar tener la"
...
label monika_eating_meat:
    ...
    m 2rsc "...Dicho esto, tampoco me considero vegana. {w=0.3}{nw}"
    ...
    m 2etc "Llegados a este punto, ¿es realmente una mejor alternativa en lo que respecta al medio ambiente? {w=0.3}{nw}"
    extend 4euc "Sin mencionar que todavía quiero tener una dieta variada y equilibrada."
    ...
    m 3rksdla "No odio el sabor de la carne, pero tampoco creo que me gustaría que fuera una parte importante de mi comida."
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt="Introvertidos y extrovertidos",
...
label monika_introverts_extroverts:
    ...
    m 4ekd "...mientras que los introvertidos son tratados como personas egoístas que sólo piensan en sí mismos, o incluso pueden ser vistos como raros por participar raramente en situaciones sociales."
    show monika 5lkc at t11 zorder MAS_MONIKA_Z with dissolve_monika
    ...
    m 5eud "Probablemente estoy haciendo este sonido como si sólo pudieras ser uno u otro, pero en realidad no es así en absoluto."
    ...
    menu:
        ...
        "Soy introvertido.":
            ...
            if persistent._mas_pm_has_friends:
                ...
                if persistent._mas_pm_feels_lonely_sometimes:
                    ...
                    m 3eka "Aún así, si alguna vez es demasiado para ti, recuerda que siempre puedes venir a mí y relajarte, ¿vale?"

                $ line_start = "Y"

            else:
                m 3eka "Aunque entiendo que puede ser más cómodo para usted estar solo que con otras personas..."
                ...
                m 2eka "Trata de hablar un poco con otras personas si no lo estás haciendo ya, ¿vale?"
        ...
        "Soy extrovertido.":
            ...
            extend 1ekbla "pero esa es sólo una razón más por la que estoy tan feliz de que seamos pareja ahora."
        ...
        "No estoy seguro.":
            ...
            m 2lksdlc "A menudo tengo que fingir mi propia confianza sólo para pasar por conversaciones simples con algunas personas."
            show monika 5eka at t11 zorder MAS_MONIKA_Z with dissolve_monika
...
label monika_renewable_energy:
    ...
    m 1rksdrb "La energía nuclear es...{w=0.2}bueno, sólo digamos que es complicado."
...
label monika_piano_lessons:
    m 1rkd "Um...{w=0.2}bueno...{w=0.2}¿Ta vez?"
    ...
    m 2ekc "Todavía tenía miedo de alejarme demasiado del guión del juego en ese momento, {w=0.2}{nw}"
...
label monika_stargazing:
    ...
    m 6dubsa "Imagínatelo...{w=0.2}sólo nosotros dos, tumbados en un campo tranquilo mirando las estrellas..."
...
label monika_taking_criticism:
    ...
    m 2eka "Después de todo, todos cometemos errores, ¿no?{w=0.3} {nw}"
