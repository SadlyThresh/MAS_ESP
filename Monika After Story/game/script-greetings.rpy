...
label greeting_honey:
    m 1hua "¡Bienvenido de nuevo, cariño!"
...
label greeting_visit8:
    m 1hua "¡Me alegro mucho de que estés aquí, [player]!"
    ...
    if mas_isMoniNormal(higher=True):
        ...
        menu:
            ...
            "Asombroso.":
                ...
                m 1hua "...¡Quizás incluso te asciendan un poco pronto!"
                ...
                if seen_event("monikaroom_greeting_ear_bathdinnerme") and renpy.random.randint(1,20) == 1:
                    ...
                    m 3eub "¡Disfrutemos un rato juntos!"
                return
...
label greeting_love_is_in_the_air:
    ...
    m 1rub "{i}~Adondequiera que mire~{/i}"
