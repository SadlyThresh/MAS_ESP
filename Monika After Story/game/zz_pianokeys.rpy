        ...
        menu:
            ...
            "Tocar una canción.":
                ...
                if pnml != "None":
                    ...
                    m 1hua "¡Estoy muy emocionada por escucharte tocar, [player]!"
...
#    hide text quit_label
    ...
    if post_piano != "mas_piano_result_none":
        ...
        $ _history_list.pop()
        menu:
            m "¿Te gustaría tocar de nuevo?{fast}"
            "Sí.":
...
label mas_piano_hb_win:
    ...
    if mas_isMonikaBirthday():
        if mas_isplayer_bday():
            ...
            m 1hua "Gracias por tocar eso en mi cumpleaños, [player]."
        ...
        m 2eub "Buen trabajo, [player]."
    m 3eub "Asegúrate de seguir practicando. ¡Estoy segura de que lo tocarás perfectamente la próxima vez!"
    return
...
label mas_piano_hb_fail:
    if mas_isMonikaBirthday():
        if mas_isMoniUpset(lower=True):
            ...
            m 1lksdla "Aprecio la idea, [player]."
            m 3eka "Incluso si no puedes conseguirlo al final del día, estoy segura de que lo harás mejor el año que viene."
    elif mas_isplayer_bday():
        ...
        m 1lksdla "..."
        m 1lksdlb "Hiciste lo mejor que pudiste, [player]..."
        m "Incluso una simple canción requiere tiempo para aprender."
    return
...
label mas_piano_hb_fc:
    ...
    if mas_isMonikaBirthday():
        if mas_isplayer_bday():
            ...
            m 1eka "Cantando la canción de cumpleaños mientras la tocas en el piano en nuestro cumpleaños..."
            m 1hua "No puedo imaginar una mejor manera de compartir nuestro día especial~"
        else:
            m 1rusdlb "¡Jajaja! Se siente raro cantar la Canción de cumpleaños para mí..."
            m 1hub "¡Pero hiciste un gran trabajo tocándola!"
            m 1ekbfa "Debes haber practicado muy duro para mí..."
            m 1hub "Estoy feliz de poder disfrutar esto contigo~"
        ...
        m 2eub "Sé que es fácil, pero lo hiciste muy bien."
...
label mas_piano_hb_prac:
    if mas_isMonikaBirthday():
        if mas_isplayer_bday():
            ...
            m 1hub "¡Te agradezco tu esfuerzo!"
    elif mas_isplayer_bday():
        m 1eksdla "Jejeje, ¿estás intentando la canción de cumpleaños en tu cumpleaños, [player]?"
        m 3hua "¡Sigue intentándolo, sé que puedes hacerlo!"
    else:
...
label mas_piano_yr_fail:
    m 1lksdlc "..."
    m 1eka "Está bien, [player]."
    m 1hua "Al menos hiciste todo lo posible."
    return
...
label mas_piano_dpco_fail:
    m 1lksdla "Creo que está bien no aprender esto..."
    return
...
#    pnml_db[pnml_dpco.name] = pnml_dpco
    ...
    def getSongChoices():
        ...
        return song_list, ("No importa", "None", False, False, 10)
...
#        CONFIG_CHANGE = "monika 3a"
        ...
        def __init__(self, mode, pnml=None):
            ...
            self._config_change_help = Text(
                _("Presiona la tecla a la que te gustaría configurar esta tecla del piano"),
                font=gui.default_font,
                size=gui.text_size,
                color="#fff",
                outlines=[]
