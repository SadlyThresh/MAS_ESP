...
init python in mas_windowutils:
    ...
    if renpy.windows:
        ...
        try:
            ...
            #Log this
            store.mas_utils.writelog("[ADVERTENCIA]: win32api/win32gui no se ha podido importar, deshabilitando las notificaciones.\n")
        ...
        if session_type == "wayland":
            store.mas_windowreacts.can_show_notifs = False
            store.mas_windowreacts.can_do_windowreacts = False
            store.mas_utils.writelog("[ADVERTENCIA]: Wayland aún no es compatible, deshabilitando las notificaciones.\n")
        ...
        #X11 however is fine
            ...
            try:
                ...
                store.mas_utils.writelog("[ADVERTENCIA]: No se ha podido importar Xlib, deshabilitando las notificaciones.\n")

        else:
            store.mas_windowreacts.can_show_notifs = False
            store.mas_windowreacts.can_do_windowreacts = False

            store.mas_utils.writelog("[ADVERTENCIA]: No se puede detectar el tipo de sesión actual, deshabilitando las notificaciones.\n")
...
init python:
    ...
    mas_other_notif_quips = [
        "¡Tengo algo de lo que hablar, [player]!",
        "¡Tengo algo que decirte, [player]!",
        "Hey [player], quiero hablarte de algo.",
        "¿Tienes un minuto, [player]?",
    ]
