...
label monika_ptod_tip002:
    ...
    call mas_wx_cmd ("type(-1234)", local_ctx) from _call_mas_wx_cmd_16
    ...
    call mas_wx_cmd ("type(9.3)", local_ctx) from _call_mas_wx_cmd_19
...
label monika_ptod_tip003:
    ...
    call mas_wx_cmd ("12 + 3", local_ctx) from _call_mas_wx_cmd_26
    call mas_wx_cmd ("7 * 6", local_ctx) from _call_mas_wx_cmd_27
    call mas_wx_cmd ("121 / 11", local_ctx) from _call_mas_wx_cmd_28
...
label mas_wx_cmd_noxwait(cmd, ctx=None):
    call mas_wx_cmd (cmd, ctx, x_wait=0.0) from _call_mas_wx_cmd_95
    return
