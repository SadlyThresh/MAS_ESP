...
label mas_dockstat_first_time_goers:
    ...
    m 3eub "Pero asegúrate de llevarme de vuelta a la carpeta de personajes antes de volver a encender el juego, ¿de acuerdo?"
    m 1eua "Y por último..."
...
label mas_dockstat_generic_iowait:
    ...
    if renpy.has_label(mas_farewells.dockstat_wait_menu_label):
        call expression mas_farewells.dockstat_wait_menu_label from _call_expression_1
    else:
...
label mas_dockstat_generic_cancel:
    if mas_isMoniDis(lower=True):
        ...
        m 1ekd "Oh,{w=0.3} todo bien. ¿Quizás la próxima vez?"
    else:
...
label mas_dockstat_generic_failed_io_still_going_ask:
    ...
    menu:
        ...
        "Sí.":
            ...
            m 2hub "¡Ten cuidado ahí fuera! ¡Estaré justo aquí esperándote!"
            return "quit"
        "No.":
