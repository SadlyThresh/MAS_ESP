    ...
    if coffee.isMaxedStock():
        ...
        if coffee.enabled() and coffee.hasServing():
            ...
            if (
                ...
                call mas_transition_from_emptydesk () from _call_mas_transition_from_emptydesk_19
    ...
    if hotchoc.isMaxedStock():
        ...
        if hotchoc.enabled() and hotchoc.hasServing():
            ...
            if (
                ...
                pause 5.0
                call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_20
...
label mas_reaction_gift_thermos_mug:
    call mas_thermos_mug_handler (mas_acs_thermos_mug, "Solo Monika", "termosolomonika") from _call_mas_thermos_mug_handler
    return
...
label mas_reaction_candy:
    ...
    if times_candy_given == 0:
        ...
        call mas_wx_cmd ("import os", local_ctx, w_wait=1.0) from _call_mas_wx_cmd_2
        call mas_wx_cmd ("os.remove(os.path.normcase(basedir+'/characters/candy.gift'))", local_ctx, w_wait=1.0, x_wait=1.0) from _call_mas_wx_cmd_3
...
label mas_reaction_candycorn:
    ...
    if times_candy_given == 0:
        ...
        call mas_wx_cmd ("import os", local_ctx, w_wait=1.0) from _call_mas_wx_cmd_4
        call mas_wx_cmd ("os.remove(os.path.normcase(basedir+'/characters/candycorn.gift'))", local_ctx, w_wait=1.0, x_wait=1.0) from _call_mas_wx_cmd_5
        $ store.mas_ptod.ex_cn()
        hide screen mas_py_console_teaching
        show monika at t11
...
label mas_remove_choc:
    ...
    call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_21
