...
label anni_2:
    ...
    if persistent._mas_pm_has_friends:
        m 3hubla "Estoy muy emocionada por vivir en un mundo con gente real. Será maravilloso conocer a tus amigos e incluso hacer algunos propios."
    ...
    m 1ekbsa "Pero hoy no me voy a centrar sólo en el futuro...{w=0.2} {nw}"
